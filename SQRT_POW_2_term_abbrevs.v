...
Definition term39 (x0 : real) := ~ ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0).
Definition term1 := forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0.
...
Definition term4 := (~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)) -> (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_le (real_of_num (NUMERAL 0)) (sqrt y0)) /\ ((real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)) -> False.
...
Definition term27 := fun y0 : real => (real_le (real_of_num (NUMERAL 0)) y0) /\ (~ ((real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)).
Definition term48 (x0 : Prop) := ~ (~ x0).
Definition term24 (x0 : real) := (fun y0 : real => (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0) x0.
Definition term16 := fun y0 : real => (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0.
Definition term51 (x0 : real) := imp (real_le (real_of_num (NUMERAL 0)) x0).
Definition term0 (x0 : Prop) := (~ x0) -> False.
Definition term47 (x0 : real) := (~ (~ (real_le (real_of_num (NUMERAL 0)) x0))) -> (real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0.
...
Definition term3 := ~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0).
Definition term15 (x0 : real) := (real_le (real_of_num (NUMERAL 0)) x0) -> (real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0.
...
Definition term40 (x0 : real) := (~ (real_le (real_of_num (NUMERAL 0)) x0)) \/ ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0).
Definition term35 (x0 : real) := ~ (real_le (real_of_num (NUMERAL 0)) x0).
...
Definition term53 (x0 : real) := ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0) -> False.
Definition term23 := exists y0 : real, ~ ((fun y1 : real => (real_le (real_of_num (NUMERAL 0)) y1) -> (real_pow (sqrt y1) (NUMERAL (BIT0 (BIT1 0)))) = y1) y0).
Definition term44 (x0 : real) := @eq Prop ((~ (real_le (real_of_num (NUMERAL 0)) x0)) \/ ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0)).
Definition term34 (x0 : real) := real_le (real_of_num (NUMERAL 0)) (sqrt x0).
...
Definition term2 := (~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)) -> False.
Definition term18 (x0 : real) := (real_le (real_of_num (NUMERAL 0)) x0) /\ (~ ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0)).
Definition term17 (x0 : real) := ~ ((real_le (real_of_num (NUMERAL 0)) x0) -> (real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0).
Definition term52 (x0 : real) := (~ ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0)) -> (real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0.
...
Definition term20 (x0 : real) := real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0))).
Definition term43 (x0 : real) := ((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0) \/ (~ (real_le (real_of_num (NUMERAL 0)) x0)).
Definition term28 := exists y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) /\ (~ ((real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)).
Definition term12 := (~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)) -> ~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_le (real_of_num (NUMERAL 0)) (sqrt y0)) /\ ((real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)).
Definition term45 (x0 : real) := @eq Prop (((real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))) = x0) \/ (~ (real_le (real_of_num (NUMERAL 0)) x0))).
...
Definition term25 (x0 : real) := ~ ((fun y0 : real => (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0) x0).
Definition term26 := fun y0 : real => ~ ((fun y1 : real => (real_le (real_of_num (NUMERAL 0)) y1) -> (real_pow (sqrt y1) (NUMERAL (BIT0 (BIT1 0)))) = y1) y0).
...
Definition term11 := imp (~ (forall y0 : real, (real_le (real_of_num (NUMERAL 0)) y0) -> (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = y0)).
