...
Definition term16 (x0 : real) (x1 : nat) := @eq real (real_zpow x0 (int_of_num x1)).
Definition term22 (a0 : Type') (x0 : Prop) := forall y0 : a0, x0.
Definition term25 := fun y0 : real => True.
...
Definition term27 := forall y0 : real, True.
Definition term28 (x0 : Prop) := forall y0 : real, x0.
Definition term26 := forall y0 : real, forall y1 : nat, (real_zpow y0 (int_of_num y1)) = (real_pow y0 y1).
...
Definition term18 (x0 : real) := fun y0 : nat => (real_zpow x0 (int_of_num y0)) = (real_pow x0 y0).
Definition term3 (x0 : nat) := int_le (int_of_num (NUMERAL 0)) (int_of_num x0).
Definition term24 := fun y0 : real => forall y1 : nat, (real_zpow y0 (int_of_num y1)) = (real_pow y0 y1).
Definition term14 (x0 : real) (x1 : nat) := real_inv (real_pow x0 (num_of_int (int_neg (int_of_num x1)))).
Definition term17 (x0 : real) (x1 : nat) := @eq real (real_pow x0 x1).
