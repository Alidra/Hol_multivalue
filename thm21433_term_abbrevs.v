...
Definition term3 (x0 : Prop) := (~ False) \/ x0.
Definition term0 (x0 : Prop) := fun y0 : Prop => (y0 -> x0) = ((~ y0) \/ x0).
Definition term4 (x0 : Prop) (x1 : Prop) := @eq Prop ((fun y0 : Prop => (y0 -> x0) = ((~ y0) \/ x0)) x1).
Definition term5 (x0 : Prop) (x1 : Prop) := (~ x0) \/ x1.
Definition term1 (x0 : Prop) (x1 : Prop) := (fun y0 : Prop => (y0 -> x0) = ((~ y0) \/ x0)) x1.
Definition term2 (x0 : Prop) := (fun y0 : Prop => (y0 -> x0) = ((~ y0) \/ x0)) False.
