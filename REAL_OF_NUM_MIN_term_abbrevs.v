...
Definition term28 (x0 : nat) (x1 : nat) := (fun y0 : nat => (Nat.min x0 y0) = (@COND nat (Peano.le x0 y0) x0 y0)) x1.
...
Definition term42 (x0 : nat) (x1 : nat) := @COND nat (Peano.le x1 x0) x1.
Definition term35 (x0 : nat) (x1 : nat) := @COND real (real_le (real_of_num x0) (real_of_num x1)) (real_of_num x0) (real_of_num x1).
...
Definition term41 (x0 : nat) (x1 : nat) := @COND nat (real_le (real_of_num x1) (real_of_num x0)) x1.
Definition term29 (x0 : nat) (x1 : nat) := @COND nat (Peano.le x0 x1) x0 x1.
...
Definition term45 (x0 : nat) (x1 : nat) := @eq real (real_min (real_of_num x0) (real_of_num x1)).
...
Definition term24 (x0 : real) (x1 : real) := (fun y0 : real => (real_min x0 y0) = (@COND real (real_le x0 y0) x0 y0)) x1.
Definition term55 := forall y0 : nat, forall y1 : nat, (real_min (real_of_num y0) (real_of_num y1)) = (real_of_num (Nat.min y0 y1)).
...
Definition term43 (x0 : nat) (x1 : nat) := @COND nat (real_le (real_of_num x0) (real_of_num x1)) x0 x1.
...
Definition term22 (x0 : real) := (fun y0 : real => forall y1 : real, (real_min y0 y1) = (@COND real (real_le y0 y1) y0 y1)) x0.
Definition term27 (x0 : nat) := forall y0 : nat, (Nat.min x0 y0) = (@COND nat (Peano.le x0 y0) x0 y0).
Definition term49 := fun y0 : nat => True.
Definition term44 (x0 : nat) (x1 : nat) := real_of_num (@COND nat (Peano.le x0 x1) x0 x1).
Definition term38 (x0 : nat) (x1 : nat) := real_of_num (@COND nat (real_le (real_of_num x0) (real_of_num x1)) x0 x1).
...
Definition term47 (x0 : nat) (x1 : nat) := real_of_num (Nat.min x0 x1).
Definition term34 (x0 : nat) (x1 : nat) := real_min (real_of_num x0) (real_of_num x1).
Definition term23 (x0 : real) := forall y0 : real, (real_min x0 y0) = (@COND real (real_le x0 y0) x0 y0).
Definition term25 (x0 : real) (x1 : real) := @COND real (real_le x0 x1) x0 x1.
Definition term30 (x0 : nat) := (fun y0 : nat => forall y1 : nat, (real_le (real_of_num y0) (real_of_num y1)) = (Peano.le y0 y1)) x0.
Definition term26 (x0 : nat) := (fun y0 : nat => forall y1 : nat, (Nat.min y0 y1) = (@COND nat (Peano.le y0 y1) y0 y1)) x0.
...
Definition term50 (x0 : nat) := forall y0 : nat, (real_min (real_of_num x0) (real_of_num y0)) = (real_of_num (Nat.min x0 y0)).
Definition term46 (x0 : nat) (x1 : nat) := @eq real (real_of_num (@COND nat (Peano.le x0 x1) x0 x1)).
...
Definition term54 := fun y0 : nat => forall y1 : nat, (real_min (real_of_num y0) (real_of_num y1)) = (real_of_num (Nat.min y0 y1)).
Definition term33 (x0 : nat) (x1 : nat) := real_le (real_of_num x0) (real_of_num x1).
Definition term48 (x0 : nat) := fun y0 : nat => (real_min (real_of_num x0) (real_of_num y0)) = (real_of_num (Nat.min x0 y0)).
