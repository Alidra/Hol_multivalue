...
Definition term206 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := (Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = True.
...
Definition term185 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) (x4 : Prop) (x5 : Prop) := ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) = x4) -> (x4 -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = x5) -> ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = (x4 -> x5).
...
Definition term221 := fun y0 : nat -> nat => True.
Definition term190 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := @nsum nat (@UNION nat (dotdot x0 x1) (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2))) x3.
...
Definition term220 := fun y0 : nat -> nat => forall y1 : nat, forall y2 : nat, forall y3 : nat, (Peano.le y1 (Nat.add y2 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot y1 (Nat.add y2 y3)) y0) = (Nat.add (@nsum nat (dotdot y1 y2) y0) (@nsum nat (dotdot (Nat.add y2 (NUMERAL (BIT1 0))) (Nat.add y2 y3)) y0)).
...
Definition term158 (a0 : Type') (x0 : a0 -> nat) := (fun y0 : a0 -> nat => forall y1 : a0 -> Prop, forall y2 : a0 -> Prop, ((@FINITE a0 y1) /\ ((@FINITE a0 y2) /\ (@DISJOINT a0 y1 y2))) -> (@nsum a0 (@UNION a0 y1 y2) y0) = (Nat.add (@nsum a0 y1 y0) (@nsum a0 y2 y0))) x0.
...
Definition term222 := forall y0 : nat -> nat, forall y1 : nat, forall y2 : nat, forall y3 : nat, (Peano.le y1 (Nat.add y2 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot y1 (Nat.add y2 y3)) y0) = (Nat.add (@nsum nat (dotdot y1 y2) y0) (@nsum nat (dotdot (Nat.add y2 (NUMERAL (BIT1 0))) (Nat.add y2 y3)) y0)).
...
Definition term161 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> nat) := forall y0 : a0 -> Prop, ((@FINITE a0 x0) /\ ((@FINITE a0 y0) /\ (@DISJOINT a0 x0 y0))) -> (@nsum a0 (@UNION a0 x0 y0) x1) = (Nat.add (@nsum a0 x0 x1) (@nsum a0 y0 x1)).
...
Definition term160 (a0 : Type') (x0 : a0 -> nat) (x1 : a0 -> Prop) := (fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, ((@FINITE a0 y0) /\ ((@FINITE a0 y1) /\ (@DISJOINT a0 y0 y1))) -> (@nsum a0 (@UNION a0 y0 y1) x0) = (Nat.add (@nsum a0 y0 x0) (@nsum a0 y1 x0))) x1.
...
Definition term210 (x0 : nat) (x1 : nat) (x2 : nat -> nat) := fun y0 : nat => (Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 y0)) x2) = (Nat.add (@nsum nat (dotdot x0 x1) x2) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 y0)) x2)).
...
Definition term166 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> nat) := Nat.add (@nsum a0 x0 x2) (@nsum a0 x1 x2).
Definition term223 := forall y0 : nat -> nat, True.
Definition term207 (x0 : nat) (x1 : nat -> nat) (x2 : nat) (x3 : nat) := ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> ((@nsum nat (dotdot x2 (Nat.add x3 x0)) x1) = (Nat.add (@nsum nat (dotdot x2 x3) x1) (@nsum nat (dotdot (Nat.add x3 (NUMERAL (BIT1 0))) (Nat.add x3 x0)) x1))) = True) -> ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x2 (Nat.add x3 x0)) x1) = (Nat.add (@nsum nat (dotdot x2 x3) x1) (@nsum nat (dotdot (Nat.add x3 (NUMERAL (BIT1 0))) (Nat.add x3 x0)) x1))) = ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> True).
Definition term157 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat) := (Peano.lt x0 x3) \/ ((Peano.lt x2 x1) \/ ((Peano.lt x0 x1) \/ (Peano.lt x2 x3))).
Definition term219 (x0 : nat -> nat) := forall y0 : nat, forall y1 : nat, forall y2 : nat, (Peano.le y0 (Nat.add y1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot y0 (Nat.add y1 y2)) x0) = (Nat.add (@nsum nat (dotdot y0 y1) x0) (@nsum nat (dotdot (Nat.add y1 (NUMERAL (BIT1 0))) (Nat.add y1 y2)) x0)).
Definition term217 (x0 : nat) (x1 : nat -> nat) := forall y0 : nat, forall y1 : nat, (Peano.le x0 (Nat.add y0 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add y0 y1)) x1) = (Nat.add (@nsum nat (dotdot x0 y0) x1) (@nsum nat (dotdot (Nat.add y0 (NUMERAL (BIT1 0))) (Nat.add y0 y1)) x1)).
...
Definition term180 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := @nsum nat (dotdot x0 (Nat.add x1 x2)) x3.
...
Definition term208 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := (Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3)).
...
Definition term205 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := @eq nat (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3)).
...
Definition term187 (x0 : nat) (x1 : nat -> nat) (x2 : nat) (x3 : nat) (x4 : Prop) := ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> ((@nsum nat (dotdot x2 (Nat.add x3 x0)) x1) = (Nat.add (@nsum nat (dotdot x2 x3) x1) (@nsum nat (dotdot (Nat.add x3 (NUMERAL (BIT1 0))) (Nat.add x3 x0)) x1))) = x4) -> ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x2 (Nat.add x3 x0)) x1) = (Nat.add (@nsum nat (dotdot x2 x3) x1) (@nsum nat (dotdot (Nat.add x3 (NUMERAL (BIT1 0))) (Nat.add x3 x0)) x1))) = ((Peano.le x2 (Nat.add x3 (NUMERAL (BIT1 0)))) -> x4).
Definition term183 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) (x4 : Prop) := forall y0 : Prop, ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) = x4) -> (x4 -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = y0) -> ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = (x4 -> y0).
...
Definition term179 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := forall y0 : Prop, forall y1 : Prop, ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) = y0) -> (y0 -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = y1) -> ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = (y0 -> y1).
...
Definition term159 (a0 : Type') (x0 : a0 -> nat) := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, ((@FINITE a0 y0) /\ ((@FINITE a0 y1) /\ (@DISJOINT a0 y0 y1))) -> (@nsum a0 (@UNION a0 y0 y1) x0) = (Nat.add (@nsum a0 y0 x0) (@nsum a0 y1 x0)).
...
Definition term184 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) (x4 : Prop) (x5 : Prop) := (fun y0 : Prop => ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) = x4) -> (x4 -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = y0) -> ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = (x4 -> y0)) x5.
...
Definition term162 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> nat) (x2 : a0 -> Prop) := (fun y0 : a0 -> Prop => ((@FINITE a0 x0) /\ ((@FINITE a0 y0) /\ (@DISJOINT a0 x0 y0))) -> (@nsum a0 (@UNION a0 x0 y0) x1) = (Nat.add (@nsum a0 x0 x1) (@nsum a0 y0 x1))) x2.
Definition term204 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := @eq nat (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3).
...
Definition term224 (x0 : Prop) := forall y0 : nat -> nat, x0.
...
Definition term181 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3).
...
Definition term188 (x0 : nat) (x1 : nat) (x2 : nat) := @nsum nat (dotdot x0 (Nat.add x1 x2)).
...
Definition term191 (x0 : nat -> Prop) (x1 : nat -> Prop) (x2 : nat -> nat) := ((@FINITE nat x0) /\ ((@FINITE nat x1) /\ (@DISJOINT nat x0 x1))) -> (@nsum nat (@UNION nat x0 x1) x2) = (Nat.add (@nsum nat x0 x2) (@nsum nat x1 x2)).
Definition term163 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> nat) := ((@FINITE a0 x0) /\ ((@FINITE a0 x1) /\ (@DISJOINT a0 x0 x1))) -> (@nsum a0 (@UNION a0 x0 x1) x2) = (Nat.add (@nsum a0 x0 x2) (@nsum a0 x1 x2)).
...
Definition term212 (x0 : nat) (x1 : nat) (x2 : nat -> nat) := forall y0 : nat, (Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 y0)) x2) = (Nat.add (@nsum nat (dotdot x0 x1) x2) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 y0)) x2)).
...
Definition term189 (x0 : nat) (x1 : nat) (x2 : nat) := @nsum nat (@UNION nat (dotdot x0 x1) (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2))).
...
Definition term182 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) (x4 : Prop) := (fun y0 : Prop => forall y1 : Prop, ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) = y0) -> (y0 -> ((@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = y1) -> ((Peano.le x0 (Nat.add x1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add x1 x2)) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3))) = (y0 -> y1)) x4.
...
Definition term216 (x0 : nat) (x1 : nat -> nat) := fun y0 : nat => forall y1 : nat, (Peano.le x0 (Nat.add y0 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot x0 (Nat.add y0 y1)) x1) = (Nat.add (@nsum nat (dotdot x0 y0) x1) (@nsum nat (dotdot (Nat.add y0 (NUMERAL (BIT1 0))) (Nat.add y0 y1)) x1)).
Definition term8 := NUMERAL (BIT1 0).
Definition term218 (x0 : nat -> nat) := fun y0 : nat => forall y1 : nat, forall y2 : nat, (Peano.le y0 (Nat.add y1 (NUMERAL (BIT1 0)))) -> (@nsum nat (dotdot y0 (Nat.add y1 y2)) x0) = (Nat.add (@nsum nat (dotdot y0 y1) x0) (@nsum nat (dotdot (Nat.add y1 (NUMERAL (BIT1 0))) (Nat.add y1 y2)) x0)).
...
Definition term192 (x0 : nat) (x1 : nat) (x2 : nat) (x3 : nat -> nat) := ((@FINITE nat (dotdot x0 x1)) /\ ((@FINITE nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2))) /\ (@DISJOINT nat (dotdot x0 x1) (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2))))) -> (@nsum nat (@UNION nat (dotdot x0 x1) (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2))) x3) = (Nat.add (@nsum nat (dotdot x0 x1) x3) (@nsum nat (dotdot (Nat.add x1 (NUMERAL (BIT1 0))) (Nat.add x1 x2)) x3)).
