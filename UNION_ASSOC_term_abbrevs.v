...
Definition term53 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0) := and (~ ((x0 x2) \/ (x1 x2))).
Definition term17 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) (x2 : a0 -> Prop) := (@IN a0 x1 x0) \/ (@IN a0 x1 x2).
Definition term47 (x0 : Prop) := ~ (~ x0).
Definition term29 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) (x2 : a0 -> Prop) (x3 : a0 -> Prop) := (@IN a0 x1 x0) \/ (@IN a0 x1 (@UNION a0 x2 x3)).
...
Definition term15 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, forall y2 : a0 -> Prop, forall y3 : a0, (@IN a0 y3 (@UNION a0 (@UNION a0 y0 y1) y2)) = (@IN a0 y3 (@UNION a0 y0 (@UNION a0 y1 y2))).
Definition term14 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, forall y2 : a0 -> Prop, (@UNION a0 (@UNION a0 y0 y1) y2) = (@UNION a0 y0 (@UNION a0 y1 y2)).
Definition term11 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, forall y2 : a0, (@IN a0 y2 (@UNION a0 (@UNION a0 x0 y0) y1)) = (@IN a0 y2 (@UNION a0 x0 (@UNION a0 y0 y1))).
...
Definition term18 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0 -> Prop) := @IN a0 x0 (@UNION a0 (@UNION a0 x1 x2) x3).
...
Definition term24 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0) := or ((x0 x2) \/ (x1 x2)).
Definition term8 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, (@UNION a0 (@UNION a0 x0 y0) y1) = (@UNION a0 x0 (@UNION a0 y0 y1)).
...
Definition term5 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := fun y0 : a0 -> Prop => forall y1 : a0, (@IN a0 y1 (@UNION a0 (@UNION a0 x0 x1) y0)) = (@IN a0 y1 (@UNION a0 x0 (@UNION a0 x1 y0))).
...
Definition term26 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0 -> Prop) := @eq Prop (@IN a0 x0 (@UNION a0 (@UNION a0 x1 x2) x3)).
Definition term66 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0) := and (((x0 x3) \/ (x1 x3)) \/ (x2 x3)).
Definition term1 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := @UNION a0 (@UNION a0 x0 x1) x2.
Definition term51 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0) := (~ (x0 x2)) /\ (~ (x1 x2)).
Definition term3 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := forall y0 : a0, (@IN a0 y0 (@UNION a0 (@UNION a0 x0 x1) x2)) = (@IN a0 y0 (@UNION a0 x0 (@UNION a0 x1 x2))).
Definition term63 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0) := and (((~ (x0 x3)) /\ (~ (x1 x3))) /\ (~ (x2 x3))).
Definition term6 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := forall y0 : a0 -> Prop, (@UNION a0 (@UNION a0 x0 x1) y0) = (@UNION a0 x0 (@UNION a0 x1 y0)).
...
Definition term2 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := @UNION a0 x0 (@UNION a0 x1 x2).
...
Definition term10 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, (@UNION a0 (@UNION a0 x0 y0) y1) = (@UNION a0 x0 (@UNION a0 y0 y1)).
Definition term4 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := fun y0 : a0 -> Prop => (@UNION a0 (@UNION a0 x0 x1) y0) = (@UNION a0 x0 (@UNION a0 x1 y0)).
Definition term23 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := or (@IN a0 x0 (@UNION a0 x1 x2)).
...
Definition term54 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0) := and ((~ (x0 x2)) /\ (~ (x1 x2))).
...
Definition term19 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0) (x3 : a0 -> Prop) := (@IN a0 x2 (@UNION a0 x0 x1)) \/ (@IN a0 x2 x3).
...
Definition term31 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := fun y0 : a0 => (@IN a0 y0 (@UNION a0 (@UNION a0 x0 x1) x2)) = (@IN a0 y0 (@UNION a0 x0 (@UNION a0 x1 x2))).
...
Definition term13 (a0 : Type') := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, forall y2 : a0 -> Prop, forall y3 : a0, (@IN a0 y3 (@UNION a0 (@UNION a0 y0 y1) y2)) = (@IN a0 y3 (@UNION a0 y0 (@UNION a0 y1 y2))).
Definition term12 (a0 : Type') := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, forall y2 : a0 -> Prop, (@UNION a0 (@UNION a0 y0 y1) y2) = (@UNION a0 y0 (@UNION a0 y1 y2)).
Definition term9 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, forall y2 : a0, (@IN a0 y2 (@UNION a0 (@UNION a0 x0 y0) y1)) = (@IN a0 y2 (@UNION a0 x0 (@UNION a0 y0 y1))).
...
Definition term7 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := forall y0 : a0 -> Prop, forall y1 : a0, (@IN a0 y1 (@UNION a0 (@UNION a0 x0 x1) y0)) = (@IN a0 y1 (@UNION a0 x0 (@UNION a0 x1 y0))).
Definition term28 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0 -> Prop) := @IN a0 x0 (@UNION a0 x1 (@UNION a0 x2 x3)).
