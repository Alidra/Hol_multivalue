...
Definition term175 (x0 : real) (x1 : real) (x2 : real) := imp ((real_le x1 x0) /\ (~ (real_le x1 x2))).
...
Definition term174 (x0 : real) (x1 : real) (x2 : real) := imp (~ ((~ (real_le x1 x0)) \/ (real_le x1 x2))).
Definition term67 (x0 : real) (x1 : real) (x2 : real) := or (~ ((real_le x0 x1) /\ (real_le x1 x2))).
Definition term150 (x0 : Prop) := ~ (~ x0).
Definition term165 (x0 : real) (x1 : real) (x2 : real) := (~ ((~ (real_le x0 x1)) \/ (real_le x0 x2))) -> ~ (real_le x1 x2).
...
Definition term45 (x0 : real) (x1 : real) := ~ (forall y0 : real, ((real_lt x1 x0) /\ (real_le x0 y0)) -> real_lt x1 y0).
Definition term85 (x0 : real) (x1 : real) := ((real_lt x1 x0) \/ (~ (~ (real_le x0 x1)))) /\ ((~ (real_lt x1 x0)) \/ (~ (real_le x0 x1))).
Definition term166 (x0 : real) (x1 : real) (x2 : real) := (~ (real_le x1 x0)) \/ (real_le x1 x2).
...
Definition term178 (x0 : real) (x1 : real) := (real_lt x0 x1) -> False.
...
Definition term12 := ((~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False.
...
Definition term176 (x0 : real) (x1 : real) (x2 : real) := ((real_le x0 x1) /\ (~ (real_le x0 x2))) -> ~ (real_le x1 x2).
Definition term35 (x0 : real) (x1 : real) := fun y0 : real => ((real_lt x1 x0) /\ (real_le x0 y0)) -> real_lt x1 y0.
Definition term40 (x0 : real) (x1 : real) (x2 : real) := ~ (((real_lt x1 x0) /\ (real_le x0 x2)) -> real_lt x1 x2).
Definition term162 (x0 : real) (x1 : real) (x2 : real) := @eq Prop ((~ (real_le x1 x0)) \/ ((~ (real_le x0 x2)) \/ (real_le x1 x2))).
...
Definition term38 (x0 : real) := forall y0 : real, forall y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) -> real_lt x0 y1.
...
Definition term8 := forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2.
Definition term163 (x0 : real) (x1 : real) (x2 : real) := @eq Prop ((real_le x0 x2) \/ ((~ (real_le x0 x1)) \/ (~ (real_le x1 x2)))).
Definition term64 := exists y0 : real, exists y1 : real, exists y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) /\ (~ (real_lt y0 y2)).
Definition term58 (x0 : real) := exists y0 : real, exists y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) /\ (~ (real_lt x0 y1)).
...
Definition term41 (x0 : real) (x1 : real) (x2 : real) := ((real_lt x1 x0) /\ (real_le x0 x2)) /\ (~ (real_lt x1 x2)).
Definition term22 := (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> ~ (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))).
Definition term108 (x0 : real) := forall y0 : real, (real_lt y0 x0) \/ (real_le x0 y0).
Definition term173 (x0 : real) (x1 : real) (x2 : real) := (real_le x1 x0) /\ (~ (real_le x1 x2)).
Definition term59 := exists y0 : real, ~ ((fun y1 : real => forall y2 : real, forall y3 : real, ((real_lt y1 y2) /\ (real_le y2 y3)) -> real_lt y1 y3) y0).
Definition term53 (x0 : real) := exists y0 : real, ~ ((fun y1 : real => forall y2 : real, ((real_lt x0 y1) /\ (real_le y1 y2)) -> real_lt x0 y2) y0).
Definition term46 (x0 : real) (x1 : real) := exists y0 : real, ~ ((fun y1 : real => ((real_lt x1 x0) /\ (real_le x0 y1)) -> real_lt x1 y1) y0).
Definition term62 := fun y0 : real => ~ ((fun y1 : real => forall y2 : real, forall y3 : real, ((real_lt y1 y2) /\ (real_le y2 y3)) -> real_lt y1 y3) y0).
Definition term56 (x0 : real) := fun y0 : real => ~ ((fun y1 : real => forall y2 : real, ((real_lt x0 y1) /\ (real_le y1 y2)) -> real_lt x0 y2) y0).
...
Definition term57 (x0 : real) := fun y0 : real => exists y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) /\ (~ (real_lt x0 y1)).
Definition term79 (x0 : real) (x1 : real) := (~ (real_lt x1 x0)) \/ (~ (real_le x0 x1)).
Definition term169 (x0 : real) (x1 : real) (x2 : real) := ~ ((~ (real_le x1 x0)) \/ (real_le x1 x2)).
Definition term89 := fun y0 : real => forall y1 : real, ((real_lt y1 y0) \/ (real_le y0 y1)) /\ ((~ (real_lt y1 y0)) \/ (~ (real_le y0 y1))).
Definition term177 (x0 : real) (x1 : real) := (~ (real_le x1 x0)) -> real_lt x0 x1.
Definition term15 := (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False.
Definition term52 (x0 : real) := ~ (forall y0 : real, forall y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) -> real_lt x0 y1).
Definition term16 := ~ (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))).
Definition term10 := ~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2).
Definition term141 (x0 : real) (x1 : real) := ~ (real_lt x0 x1).
Definition term0 (x0 : Prop) := (fun y0 : Prop => forall y1 : Prop, forall y2 : Prop, (y0 \/ (y1 \/ y2)) = ((y0 \/ y1) \/ y2)) x0.
Definition term51 (x0 : real) (x1 : real) := exists y0 : real, ((real_lt x1 x0) /\ (real_le x0 y0)) /\ (~ (real_lt x1 y0)).
...
Definition term61 (x0 : real) := ~ ((fun y0 : real => forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2) x0).
...
Definition term13 := (((~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False.
...
Definition term37 (x0 : real) := fun y0 : real => forall y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) -> real_lt x0 y1.
...
Definition term48 (x0 : real) (x1 : real) (x2 : real) := ~ ((fun y0 : real => ((real_lt x1 x0) /\ (real_le x0 y0)) -> real_lt x1 y0) x2).
...
Definition term9 := (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> False.
...
Definition term164 (x0 : real) (x1 : real) (x2 : real) := (~ (real_le x0 x2)) \/ ((~ (real_le x1 x0)) \/ (real_le x1 x2)).
Definition term47 (x0 : real) (x1 : real) (x2 : real) := (fun y0 : real => ((real_lt x1 x0) /\ (real_le x0 y0)) -> real_lt x1 y0) x2.
...
Definition term14 := (((~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> ((~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False) -> (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False.
Definition term159 (x0 : real) (x1 : real) := or (~ (real_le x0 x1)).
...
Definition term54 (x0 : real) (x1 : real) := (fun y0 : real => forall y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) -> real_lt x0 y1) x1.
Definition term171 (x0 : real) (x1 : real) := and (~ (~ (real_le x0 x1))).
Definition term101 (x0 : real) (x1 : real) := (fun y0 : real => (~ (real_lt y0 x0)) \/ (~ (real_le x0 y0))) x1.
Definition term42 (x0 : real) (x1 : real) (x2 : real) := (real_lt x0 x1) /\ (real_le x1 x2).
...
Definition term39 := fun y0 : real => forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2.
Definition term32 := fun y0 : real => forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2.
Definition term55 (x0 : real) (x1 : real) := ~ ((fun y0 : real => forall y1 : real, ((real_lt x0 y0) /\ (real_le y0 y1)) -> real_lt x0 y1) x1).
Definition term63 := fun y0 : real => exists y1 : real, exists y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) /\ (~ (real_lt y0 y2)).
...
Definition term36 (x0 : real) (x1 : real) := forall y0 : real, ((real_lt x1 x0) /\ (real_le x0 y0)) -> real_lt x1 y0.
...
Definition term172 (x0 : real) (x1 : real) := and (real_le x0 x1).
...
Definition term49 (x0 : real) (x1 : real) := fun y0 : real => ~ ((fun y1 : real => ((real_lt x1 x0) /\ (real_le x0 y1)) -> real_lt x1 y1) y0).
...
Definition term160 (x0 : real) (x1 : real) (x2 : real) := (~ (real_le x0 x1)) \/ ((real_le x0 x2) \/ (~ (real_le x1 x2))).
...
Definition term34 (x0 : real) (x1 : real) (x2 : real) := ((real_lt x1 x0) /\ (real_le x0 x2)) -> real_lt x1 x2.
Definition term137 (x0 : real) := (fun y0 : real => forall y1 : real, forall y2 : real, ((~ (real_le y0 y1)) \/ (~ (real_le y1 y2))) \/ (real_le y0 y2)) x0.
Definition term60 (x0 : real) := (fun y0 : real => forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2) x0.
Definition term11 := (~ (forall y0 : real, forall y1 : real, forall y2 : real, ((real_lt y0 y1) /\ (real_le y1 y2)) -> real_lt y0 y2)) -> (forall y0 : real, forall y1 : real, forall y2 : real, ((real_le y0 y1) /\ (real_le y1 y2)) -> real_le y0 y2) -> (forall y0 : real, forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) -> False.
...
Definition term161 (x0 : real) (x1 : real) (x2 : real) := (real_le x0 x2) \/ ((~ (real_le x0 x1)) \/ (~ (real_le x1 x2))).
...
Definition term50 (x0 : real) (x1 : real) := fun y0 : real => ((real_lt x1 x0) /\ (real_le x0 y0)) /\ (~ (real_lt x1 y0)).
Definition term66 (x0 : real) (x1 : real) (x2 : real) := (~ (real_le x0 x1)) \/ (~ (real_le x1 x2)).
Definition term170 (x0 : real) (x1 : real) (x2 : real) := (~ (~ (real_le x1 x0))) /\ (~ (real_le x1 x2)).
