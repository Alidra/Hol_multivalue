...
Definition term4 := forall y0 : nat, (Nat.add (BIT0 y0) 0) = (BIT0 y0).
...
Definition term5 (x0 : nat) := (fun y0 : nat => (Nat.add (BIT0 y0) 0) = (BIT0 y0)) x0.
Definition term10 := S (BIT0 (BIT1 0)).
Definition term8 := BIT0 (BIT1 0).
Definition term9 := S (Nat.add (BIT0 (BIT1 0)) 0).
Definition term6 (x0 : nat) := Nat.add (BIT0 x0) 0.
Definition term7 := Nat.add (BIT0 (BIT1 0)) 0.
