...
Definition term20 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : a0 -> a1, forall y1 : a0 -> a2, (fun y2 : type1430 a0 a1 a2 => x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y2) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y2)) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2)).
Definition term51 (a0 : Type') (a1 : Type') (x0 : a0) (x1 : a1) := @fst a0 a1 (@pair a0 a1 x0 x1).
Definition term12 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) (x1 : a0 -> a1) := all (x0 x1).
Definition term33 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) (x1 : a0 -> a1) := forall y0 : a0 -> a2, x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) (fun y1 : a0 => @pair a1 a2 (x1 y1) (y0 y1))) (@o a0 (prod a1 a2) a2 (@snd a1 a2) (fun y1 : a0 => @pair a1 a2 (x1 y1) (y0 y1))).
...
Definition term25 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : type1430 a0 a1 a2, x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y0) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y0).
...
Definition term14 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := fun y0 : a0 -> a1 => all (x0 y0).
...
Definition term15 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : a0 -> a1, forall y1 : a0 -> a2, x0 y0 y1.
Definition term16 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : a0 -> a1, all (x0 y0).
...
Definition term34 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := fun y0 : a0 -> a1 => forall y1 : a0 -> a2, (fun y2 : type1430 a0 a1 a2 => x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y2) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y2)) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2)).
Definition term61 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop (((forall y0 : a0 -> a1, all (x0 y0)) = (forall y0 : a0 -> a1, all (x0 y0))) = True).
Definition term64 (a0 : Type') (a1 : Type') (a2 : Type') := forall y0 : type524 a0 a1 a2, (forall y1 : a0 -> a1, forall y2 : a0 -> a2, y0 y1 y2) = (forall y1 : type1430 a0 a1 a2, y0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y1) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y1)).
...
Definition term26 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop (forall y0 : type1430 a0 a1 a2, (fun y1 : type1430 a0 a1 a2 => x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y1) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y1)) y0).
Definition term60 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop ((fun y0 : Prop => y0 = True) ((forall y0 : a0 -> a1, all (x0 y0)) = (forall y0 : a0 -> a1, all (x0 y0)))).
Definition term19 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : type1430 a0 a1 a2, (fun y1 : type1430 a0 a1 a2 => x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y1) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y1)) y0.
...
Definition term27 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop (forall y0 : type1430 a0 a1 a2, x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y0) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y0)).
Definition term8 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type478 a0 a1 a2) := forall y0 : a0 -> a1, forall y1 : a0 -> a2, x0 (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2)).
Definition term2 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : a1 -> a2) := (fun y0 : a1 -> a2 => forall y1 : a0 -> a1, (@o a0 a1 a2 y0 y1) = (fun y2 : a0 => y0 (y1 y2))) x0.
Definition term36 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := forall y0 : a0 -> a1, forall y1 : a0 -> a2, x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2))) (@o a0 (prod a1 a2) a2 (@snd a1 a2) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2))).
...
Definition term13 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := fun y0 : a0 -> a1 => forall y1 : a0 -> a2, x0 y0 y1.
Definition term6 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type478 a0 a1 a2) := (fun y0 : type478 a0 a1 a2 => (forall y1 : type1430 a0 a1 a2, y0 y1) = (forall y1 : a0 -> a1, forall y2 : a0 -> a2, y0 (fun y3 : a0 => @pair a1 a2 (y1 y3) (y2 y3)))) x0.
Definition term11 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) (x1 : a0 -> a1) := forall y0 : a0 -> a2, x0 x1 y0.
...
Definition term7 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type478 a0 a1 a2) := forall y0 : type1430 a0 a1 a2, x0 y0.
Definition term58 (a0 : Type') (a1 : Type') (x0 : a0) (x1 : a1) := @snd a0 a1 (@pair a0 a1 x0 x1).
Definition term32 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) (x1 : a0 -> a1) := forall y0 : a0 -> a2, (fun y1 : type1430 a0 a1 a2 => x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y1) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y1)) (fun y1 : a0 => @pair a1 a2 (x1 y1) (y0 y1)).
...
Definition term62 (a0 : Type') (a1 : Type') (a2 : Type') := fun y0 : type524 a0 a1 a2 => (forall y1 : a0 -> a1, forall y2 : a0 -> a2, y0 y1 y2) = (forall y1 : type1430 a0 a1 a2, y0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) y1) (@o a0 (prod a1 a2) a2 (@snd a1 a2) y1)).
...
Definition term59 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := (fun y0 : Prop => y0 = True) ((forall y0 : a0 -> a1, all (x0 y0)) = (forall y0 : a0 -> a1, all (x0 y0))).
Definition term17 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop (forall y0 : a0 -> a1, forall y1 : a0 -> a2, x0 y0 y1).
...
Definition term18 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := @eq Prop (forall y0 : a0 -> a1, all (x0 y0)).
Definition term35 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type524 a0 a1 a2) := fun y0 : a0 -> a1 => forall y1 : a0 -> a2, x0 (@o a0 (prod a1 a2) a1 (@fst a1 a2) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2))) (@o a0 (prod a1 a2) a2 (@snd a1 a2) (fun y2 : a0 => @pair a1 a2 (y0 y2) (y1 y2))).
