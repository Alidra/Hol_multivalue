...
Definition term3 (a0 : Type') (x0 : a0) (x1 : a0) (x2 : Prop) (x3 : a0) (x4 : a0) := (True = x2) -> (x2 -> x0 = x3) -> ((~ x2) -> x1 = x4) -> (@COND a0 True x0 x1) = (@COND a0 x2 x3 x4).
...
Definition term2 (a0 : Type') (x0 : a0) (x1 : a0) (x2 : Prop) (x3 : a0) (x4 : a0) := (fun y0 : Prop => (y0 = x2) -> (x2 -> x0 = x3) -> ((~ x2) -> x1 = x4) -> (@COND a0 y0 x0 x1) = (@COND a0 x2 x3 x4)) True.
