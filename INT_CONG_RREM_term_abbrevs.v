...
Definition term26 (x0 : int) (x1 : int) := forall y0 : int, (@eq2 int x0 (rem x1 y0) (int_mod y0)) = (@eq2 int x0 x1 (int_mod y0)).
Definition term3 (x0 : int) (x1 : int) := forall y0 : int, ((rem x0 y0) = (rem x1 y0)) = (@eq2 int x0 x1 (int_mod y0)).
Definition term30 (x0 : int) := fun y0 : int => forall y1 : int, (@eq2 int x0 (rem y0 y1) (int_mod y1)) = (@eq2 int x0 y0 (int_mod y1)).
...
Definition term24 (x0 : int) (x1 : int) := fun y0 : int => (@eq2 int x0 (rem x1 y0) (int_mod y0)) = (@eq2 int x0 x1 (int_mod y0)).
Definition term32 := fun y0 : int => forall y1 : int, forall y2 : int, (@eq2 int y0 (rem y1 y2) (int_mod y2)) = (@eq2 int y0 y1 (int_mod y2)).
...
Definition term33 := forall y0 : int, forall y1 : int, forall y2 : int, (@eq2 int y0 (rem y1 y2) (int_mod y2)) = (@eq2 int y0 y1 (int_mod y2)).
Definition term31 (x0 : int) := forall y0 : int, forall y1 : int, (@eq2 int x0 (rem y0 y1) (int_mod y1)) = (@eq2 int x0 y0 (int_mod y1)).
...
Definition term21 (x0 : int) (x1 : int) := @eq int (rem x0 x1).
Definition term27 := forall y0 : int, True.
Definition term20 (x0 : int) (x1 : int) (x2 : int) := @eq2 int x0 (rem x1 x2) (int_mod x2).
Definition term23 (x0 : int) (x1 : int) (x2 : int) := @eq Prop ((rem x0 x2) = (rem x1 x2)).
Definition term22 (x0 : int) (x1 : int) (x2 : int) := @eq Prop (@eq2 int x0 (rem x1 x2) (int_mod x2)).
