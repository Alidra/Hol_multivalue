...
Definition term3 (x0 : nat) (x1 : nat) := @INSERT nat (S x1) (dotdot x0 x1).
...
Definition term4 (x0 : nat) (x1 : nat) := forall y0 : nat, (@IN nat y0 (dotdot x0 (S x1))) = (@IN nat y0 (@INSERT nat (S x1) (dotdot x0 x1))).
