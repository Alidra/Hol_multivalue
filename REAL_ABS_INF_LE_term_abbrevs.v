...
Definition term14 (x0 : real) (x1 : real -> Prop) (x2 : real) := (fun y0 : real => ((~ (x1 = (@EMPTY real))) /\ (forall y1 : real, (@IN real y1 x1) -> (real_le x0 y1) /\ (real_le y1 y0))) -> (real_le x0 (inf x1)) /\ (real_le (inf x1) y0)) x2.
...
Definition term15 (x0 : real) (x1 : real -> Prop) (x2 : real) := ((~ (x1 = (@EMPTY real))) /\ (forall y0 : real, (@IN real y0 x1) -> (real_le x0 y0) /\ (real_le y0 x2))) -> (real_le x0 (inf x1)) /\ (real_le (inf x1) x2).
Definition term11 (x0 : real -> Prop) := forall y0 : real, forall y1 : real, ((~ (x0 = (@EMPTY real))) /\ (forall y2 : real, (@IN real y2 x0) -> (real_le y0 y2) /\ (real_le y2 y1))) -> (real_le y0 (inf x0)) /\ (real_le (inf x0) y1).
...
Definition term13 (x0 : real) (x1 : real -> Prop) := forall y0 : real, ((~ (x1 = (@EMPTY real))) /\ (forall y1 : real, (@IN real y1 x1) -> (real_le x0 y1) /\ (real_le y1 y0))) -> (real_le x0 (inf x1)) /\ (real_le (inf x1) y0).
Definition term31 (x0 : real -> Prop) (x1 : real) := (real_le (real_neg x1) (inf x0)) /\ (real_le (inf x0) x1).
...
Definition term36 (x0 : real -> Prop) := forall y0 : real, ((~ (x0 = (@EMPTY real))) /\ (forall y1 : real, (@IN real y1 x0) -> real_le (real_abs y1) y0)) -> real_le (real_abs (inf x0)) y0.
Definition term34 (x0 : real -> Prop) := fun y0 : real => ((~ (x0 = (@EMPTY real))) /\ (forall y1 : real, (@IN real y1 x0) -> real_le (real_abs y1) y0)) -> real_le (real_abs (inf x0)) y0.
Definition term21 (x0 : real -> Prop) (x1 : real) := fun y0 : real => (@IN real y0 x0) -> real_le (real_abs y0) x1.
Definition term30 (x0 : real -> Prop) (x1 : real) := real_le (real_abs (inf x0)) x1.
Definition term12 (x0 : real -> Prop) (x1 : real) := (fun y0 : real => forall y1 : real, ((~ (x0 = (@EMPTY real))) /\ (forall y2 : real, (@IN real y2 x0) -> (real_le y0 y2) /\ (real_le y2 y1))) -> (real_le y0 (inf x0)) /\ (real_le (inf x0) y1)) x1.
Definition term24 (x0 : real -> Prop) (x1 : real) := forall y0 : real, (@IN real y0 x0) -> (real_le (real_neg x1) y0) /\ (real_le y0 x1).
Definition term42 := forall y0 : real -> Prop, forall y1 : real, ((~ (y0 = (@EMPTY real))) /\ (forall y2 : real, (@IN real y2 y0) -> real_le (real_abs y2) y1)) -> real_le (real_abs (inf y0)) y1.
Definition term40 := fun y0 : real -> Prop => forall y1 : real, ((~ (y0 = (@EMPTY real))) /\ (forall y2 : real, (@IN real y2 y0) -> real_le (real_abs y2) y1)) -> real_le (real_abs (inf y0)) y1.
Definition term10 (x0 : real -> Prop) := (fun y0 : real -> Prop => forall y1 : real, forall y2 : real, ((~ (y0 = (@EMPTY real))) /\ (forall y3 : real, (@IN real y3 y0) -> (real_le y1 y3) /\ (real_le y3 y2))) -> (real_le y1 (inf y0)) /\ (real_le (inf y0) y2)) x0.
Definition term44 (x0 : Prop) := forall y0 : real -> Prop, x0.
Definition term32 (x0 : real -> Prop) (x1 : real) := ((~ (x0 = (@EMPTY real))) /\ (forall y0 : real, (@IN real y0 x0) -> real_le (real_abs y0) x1)) -> real_le (real_abs (inf x0)) x1.
...
Definition term33 (x0 : real -> Prop) (x1 : real) := ((~ (x0 = (@EMPTY real))) /\ (forall y0 : real, (@IN real y0 x0) -> (real_le (real_neg x1) y0) /\ (real_le y0 x1))) -> (real_le (real_neg x1) (inf x0)) /\ (real_le (inf x0) x1).
