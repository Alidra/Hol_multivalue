...
Definition term11 := int_le (int_of_num (NUMERAL 0)) (int_of_num (NUMERAL (BIT1 0))).
...
Definition term3 := real_le (real_of_num (NUMERAL 0)).
...
Definition term9 := real_le (real_of_int (int_of_num (NUMERAL 0))) (real_of_int (int_of_num (NUMERAL (BIT1 0)))).
Definition term6 := real_of_int (int_of_num (NUMERAL (BIT1 0))).
Definition term8 := real_le (real_of_num (NUMERAL 0)) (real_of_num (NUMERAL (BIT1 0))).
Definition term4 := real_le (real_of_int (int_of_num (NUMERAL 0))).
