...
Definition term1 (x0 : int) := ((real_of_int x0) = (real_of_num (NUMERAL 0))) \/ (real_lt (real_of_num (NUMERAL 0)) (real_abs (real_of_int x0))).
Definition term16 (x0 : int) := int_lt (int_of_num (NUMERAL 0)) (int_abs x0).
Definition term13 (x0 : int) := real_lt (real_of_num (NUMERAL 0)) (real_abs (real_of_int x0)).
Definition term12 (x0 : int) := real_of_int (int_abs x0).
...
Definition term17 (x0 : int) := (x0 = (int_of_num (NUMERAL 0))) \/ (int_lt (int_of_num (NUMERAL 0)) (int_abs x0)).
Definition term14 (x0 : int) := real_lt (real_of_int (int_of_num (NUMERAL 0))) (real_of_int (int_abs x0)).
Definition term7 (x0 : int) := or ((real_of_int x0) = (real_of_num (NUMERAL 0))).
Definition term5 (x0 : int) := @eq real (real_of_int x0).
Definition term11 (x0 : int) := real_abs (real_of_int x0).
