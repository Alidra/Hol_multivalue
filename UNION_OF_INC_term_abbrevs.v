...
Definition term43 (a0 : Type') (x0 : type686 a0) (x1 : a0 -> Prop) := (forall y0 : a0 -> Prop, (@IN (a0 -> Prop) y0 (@INSERT (a0 -> Prop) x1 (@EMPTY (a0 -> Prop)))) -> x0 y0) /\ ((@UNIONS a0 (@INSERT (a0 -> Prop) x1 (@EMPTY (a0 -> Prop)))) = x1).
...
Definition term12 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := @eq Prop ((fun y0 : a0 -> Prop => (fun y1 : a0 -> Prop => exists y2 : type686 a0, (x0 y2) /\ ((forall y3 : a0 -> Prop, (@IN (a0 -> Prop) y3 y2) -> x1 y3) /\ ((@UNIONS a0 y2) = y1))) y0) x2).
Definition term16 (a0 : Type') (x0 : a0) (x1 : a0) := (fun y0 : a0 => (@IN a0 x0 (@INSERT a0 y0 (@EMPTY a0))) = (x0 = y0)) x1.
Definition term11 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) := fun y0 : a0 -> Prop => (fun y1 : a0 -> Prop => exists y2 : type686 a0, (x0 y2) /\ ((forall y3 : a0 -> Prop, (@IN (a0 -> Prop) y3 y2) -> x1 y3) /\ ((@UNIONS a0 y2) = y1))) y0.
Definition term44 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := (x0 (@INSERT (a0 -> Prop) x2 (@EMPTY (a0 -> Prop)))) /\ ((forall y0 : a0 -> Prop, (@IN (a0 -> Prop) y0 (@INSERT (a0 -> Prop) x2 (@EMPTY (a0 -> Prop)))) -> x1 y0) /\ ((@UNIONS a0 (@INSERT (a0 -> Prop) x2 (@EMPTY (a0 -> Prop)))) = x2)).
Definition term8 (a0 : Type') (x0 : type686 a0) (x1 : a0 -> Prop) := (fun y0 : a0 -> Prop => x0 y0) x1.
Definition term6 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := (fun y0 : a0 -> Prop => exists y1 : type686 a0, (x0 y1) /\ ((forall y2 : a0 -> Prop, (@IN (a0 -> Prop) y2 y1) -> x1 y2) /\ ((@UNIONS a0 y1) = y0))) x2.
Definition term45 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := fun y0 : type686 a0 => (x0 y0) /\ ((forall y1 : a0 -> Prop, (@IN (a0 -> Prop) y1 y0) -> x1 y1) /\ ((@UNIONS a0 y0) = x2)).
Definition term39 (a0 : Type') (x0 : Prop) := forall y0 : a0 -> Prop, x0.
Definition term49 (a0 : Type') := forall y0 : type180 a0, forall y1 : type686 a0, forall y2 : a0 -> Prop, ((y0 (@INSERT (a0 -> Prop) y2 (@EMPTY (a0 -> Prop)))) /\ (y1 y2)) -> @UNION_OF a0 y0 y1 y2.
...
Definition term47 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) := forall y0 : a0 -> Prop, ((x0 (@INSERT (a0 -> Prop) y0 (@EMPTY (a0 -> Prop)))) /\ (x1 y0)) -> @UNION_OF a0 x0 x1 y0.
...
Definition term46 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := ((x0 (@INSERT (a0 -> Prop) x2 (@EMPTY (a0 -> Prop)))) /\ (x1 x2)) -> @UNION_OF a0 x0 x1 x2.
...
Definition term10 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := exists y0 : type686 a0, (x0 y0) /\ ((forall y1 : a0 -> Prop, (@IN (a0 -> Prop) y1 y0) -> x1 y1) /\ ((@UNIONS a0 y0) = x2)).
...
Definition term48 (a0 : Type') (x0 : type180 a0) := forall y0 : type686 a0, forall y1 : a0 -> Prop, ((x0 (@INSERT (a0 -> Prop) y1 (@EMPTY (a0 -> Prop)))) /\ (y0 y1)) -> @UNION_OF a0 x0 y0 y1.
Definition term42 (a0 : Type') (x0 : a0 -> Prop) := @eq (a0 -> Prop) (@UNIONS a0 (@INSERT (a0 -> Prop) x0 (@EMPTY (a0 -> Prop)))).
...
Definition term13 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := @eq Prop ((fun y0 : a0 -> Prop => exists y1 : type686 a0, (x0 y1) /\ ((forall y2 : a0 -> Prop, (@IN (a0 -> Prop) y2 y1) -> x1 y2) /\ ((@UNIONS a0 y1) = y0))) x2).
...
Definition term41 (a0 : Type') (x0 : a0 -> Prop) := @UNIONS a0 (@INSERT (a0 -> Prop) x0 (@EMPTY (a0 -> Prop))).
...
Definition term9 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := (fun y0 : a0 -> Prop => (fun y1 : a0 -> Prop => exists y2 : type686 a0, (x0 y2) /\ ((forall y3 : a0 -> Prop, (@IN (a0 -> Prop) y3 y2) -> x1 y3) /\ ((@UNIONS a0 y2) = y1))) y0) x2.
