...
Definition term14 (x0 : int) := @eq Prop (real_le (real_neg (real_of_int x0)) (real_of_num (NUMERAL 0))).
Definition term1 (x0 : int) := real_le (real_neg (real_of_int x0)) (real_of_num (NUMERAL 0)).
Definition term9 := real_of_int (int_of_num (NUMERAL 0)).
Definition term8 := real_of_num (NUMERAL 0).
Definition term12 (x0 : int) := int_le (int_neg x0) (int_of_num (NUMERAL 0)).
Definition term13 := int_of_num (NUMERAL 0).
Definition term10 (x0 : int) := real_le (real_of_int (int_neg x0)) (real_of_int (int_of_num (NUMERAL 0))).
...
Definition term20 := forall y0 : int, (int_le (int_neg y0) (int_of_num (NUMERAL 0))) = (int_le (int_of_num (NUMERAL 0)) y0).
Definition term0 (x0 : int) := (fun y0 : real => (real_le (real_neg y0) (real_of_num (NUMERAL 0))) = (real_le (real_of_num (NUMERAL 0)) y0)) (real_of_int x0).
Definition term15 (x0 : int) := @eq Prop (int_le (int_neg x0) (int_of_num (NUMERAL 0))).
