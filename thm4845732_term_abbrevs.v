...
Definition term12 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := imp (@UNION_OF a0 x0 x1 x2).
...
Definition term17 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := fun y0 : a0 -> Prop => (exists y1 : type686 a0, (x0 y1) /\ ((forall y2 : a0 -> Prop, (@IN (a0 -> Prop) y2 y1) -> x1 y2) /\ ((@UNIONS a0 y1) = y0))) -> x2 y0.
...
Definition term18 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := forall y0 : a0 -> Prop, (@UNION_OF a0 x0 x1 y0) -> x2 y0.
...
Definition term15 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) (x3 : a0 -> Prop) := (exists y0 : type686 a0, (x0 y0) /\ ((forall y1 : a0 -> Prop, (@IN (a0 -> Prop) y1 y0) -> x1 y1) /\ ((@UNIONS a0 y0) = x3))) -> x2 x3.
Definition term16 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := fun y0 : a0 -> Prop => (@UNION_OF a0 x0 x1 y0) -> x2 y0.
...
Definition term21 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := @eq Prop (forall y0 : a0 -> Prop, (exists y1 : type686 a0, (x0 y1) /\ ((forall y2 : a0 -> Prop, (@IN (a0 -> Prop) y2 y1) -> x1 y2) /\ ((@UNIONS a0 y1) = y0))) -> x2 y0).
Definition term20 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := @eq Prop (forall y0 : a0 -> Prop, (@UNION_OF a0 x0 x1 y0) -> x2 y0).
Definition term19 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := forall y0 : a0 -> Prop, (exists y1 : type686 a0, (x0 y1) /\ ((forall y2 : a0 -> Prop, (@IN (a0 -> Prop) y2 y1) -> x1 y2) /\ ((@UNIONS a0 y1) = y0))) -> x2 y0.
Definition term22 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) := forall y0 : type686 a0, ((x0 y0) /\ (forall y1 : a0 -> Prop, (@IN (a0 -> Prop) y1 y0) -> x1 y1)) -> x2 (@UNIONS a0 y0).
...
Definition term14 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : type686 a0) (x3 : a0 -> Prop) := (@UNION_OF a0 x0 x1 x3) -> x2 x3.
Definition term13 (a0 : Type') (x0 : type180 a0) (x1 : type686 a0) (x2 : a0 -> Prop) := imp (exists y0 : type686 a0, (x0 y0) /\ ((forall y1 : a0 -> Prop, (@IN (a0 -> Prop) y1 y0) -> x1 y1) /\ ((@UNIONS a0 y0) = x2))).
