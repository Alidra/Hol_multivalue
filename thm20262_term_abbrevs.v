...
Definition term3 (x0 : Prop) (x1 : Prop) (x2 : Prop) := (((False = False) -> x0 = x2) /\ ((False = True) -> x0 = x1)) -> x0 = ((False /\ x1) \/ ((~ False) /\ x2)).
Definition term0 (x0 : Prop) (x1 : Prop) (x2 : Prop) := fun y0 : Prop => (((y0 = False) -> x0 = x2) /\ ((y0 = True) -> x0 = x1)) -> x0 = ((y0 /\ x1) \/ ((~ y0) /\ x2)).
Definition term2 (x0 : Prop) (x1 : Prop) (x2 : Prop) := (fun y0 : Prop => (((y0 = False) -> x0 = x2) /\ ((y0 = True) -> x0 = x1)) -> x0 = ((y0 /\ x1) \/ ((~ y0) /\ x2))) False.
