...
Definition term16 (x0 : nat) (x1 : nat) := @eq nat (Nat.add (Nat.mul x1 (Nat.div x0 x1)) (Nat.modulo x0 x1)).
...
Definition term13 (x0 : nat) (x1 : nat) := Nat.add (Nat.mul x1 (Nat.div x0 x1)).
Definition term15 (x0 : nat) (x1 : nat) := Nat.add (Nat.mul x1 (Nat.div x0 x1)) (Nat.modulo x0 x1).
...
Definition term11 (x0 : nat) (x1 : nat) := Nat.mul x1 (Nat.div x0 x1).
Definition term14 := Nat.add (NUMERAL 0).
Definition term10 := Nat.mul (NUMERAL 0).
Definition term12 := Nat.mul (NUMERAL 0) (NUMERAL 0).
