...
Definition term39 (x0 : real) (x1 : real) (x2 : real) := @eq Prop (real_le (real_div x0 x1) x2).
...
Definition term69 (x0 : real) (x1 : real) := forall y0 : real, (real_lt (real_of_num (NUMERAL 0)) y0) -> (real_le (real_div x0 y0) x1) = (real_le x0 (real_mul x1 y0)).
...
Definition term71 := forall y0 : real, forall y1 : real, forall y2 : real, (real_lt (real_of_num (NUMERAL 0)) y2) -> (real_le (real_div y0 y2) y1) = (real_le y0 (real_mul y1 y2)).
Definition term70 (x0 : real) := forall y0 : real, forall y1 : real, (real_lt (real_of_num (NUMERAL 0)) y1) -> (real_le (real_div x0 y1) y0) = (real_le x0 (real_mul y0 y1)).
...
Definition term40 (x0 : real) (x1 : real) (x2 : real) := @eq Prop (real_le (real_mul (real_div x0 x2) x2) (real_mul x1 x2)).
Definition term60 (x0 : real) (x1 : real) := real_mul (real_div x0 x1).
Definition term38 (x0 : real) (x1 : real) (x2 : real) := real_le (real_mul (real_div x0 x2) x2) (real_mul x1 x2).
...
Definition term37 (x0 : real) (x1 : real) (x2 : real) := real_le (real_div x0 x1) x2.
Definition term66 (x0 : real) (x1 : real) := real_le (real_mul (real_div x0 x1) x1).
...
Definition term67 (x0 : real) (x1 : real) (x2 : real) := @eq Prop (real_le x0 (real_mul x1 x2)).
Definition term14 (x0 : real) := real_lt (real_of_num (NUMERAL 0)) x0.
Definition term41 (x0 : real) (x1 : real) (x2 : real) := real_le x0 (real_mul x1 x2).
...
Definition term68 (x0 : real) (x1 : real) (x2 : real) := (real_lt (real_of_num (NUMERAL 0)) x2) -> (real_le (real_div x0 x2) x1) = (real_le x0 (real_mul x1 x2)).
