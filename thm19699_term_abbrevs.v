...
Definition term29 (x0 : Prop) := (fun y0 : Prop => y0 = (y0 /\ (x0 \/ y0))) False.
Definition term26 (x0 : Prop) := True /\ (x0 \/ True).
Definition term30 (x0 : Prop) := False /\ (x0 \/ False).
Definition term23 (x0 : Prop) := fun y0 : Prop => y0 = (y0 /\ (x0 \/ y0)).
Definition term17 (x0 : Prop) := and (True \/ x0).
Definition term25 (x0 : Prop) := (fun y0 : Prop => y0 = (y0 /\ (x0 \/ y0))) True.
Definition term4 (x0 : Prop) (x1 : Prop) := (fun y0 : Prop => ((y0 /\ x0) \/ x1) = ((y0 \/ x1) /\ (x0 \/ x1))) True.
Definition term14 (x0 : Prop) := or (True /\ x0).
Definition term28 (x0 : Prop) (x1 : Prop) := @eq Prop (x1 = (x1 /\ (x0 \/ x1))).
Definition term13 (x0 : Prop) (x1 : Prop) := (False \/ x1) /\ (x0 \/ x1).
Definition term31 (x0 : Prop) := ~ (False /\ (x0 \/ False)).
Definition term19 (x0 : Prop) := or (False /\ x0).
...
Definition term27 (x0 : Prop) (x1 : Prop) := @eq Prop ((fun y0 : Prop => y0 = (y0 /\ (x0 \/ y0))) x1).
...
Definition term20 (x0 : Prop) (x1 : Prop) := @eq Prop ((False /\ x0) \/ x1).
Definition term15 (x0 : Prop) (x1 : Prop) := @eq Prop ((True /\ x0) \/ x1).
Definition term21 (x0 : Prop) := and (False \/ x0).
Definition term22 (x0 : Prop) (x1 : Prop) := x1 /\ (x0 \/ x1).
Definition term18 (x0 : Prop) (x1 : Prop) := True /\ (x0 \/ x1).
Definition term16 (x0 : Prop) (x1 : Prop) := @eq Prop (x0 \/ x1).
Definition term0 (x0 : Prop) := (fun y0 : Prop => (y0 = True) \/ (y0 = False)) x0.
Definition term24 (x0 : Prop) (x1 : Prop) := (fun y0 : Prop => y0 = (y0 /\ (x0 \/ y0))) x1.
