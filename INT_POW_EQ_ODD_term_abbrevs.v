...
Definition term14 (x0 : int) (x1 : int) (x2 : nat) := imp ((Coq.Arith.PeanoNat.Nat.Odd x2) /\ ((int_pow x0 x2) = (int_pow x1 x2))).
Definition term13 (x0 : int) (x1 : int) (x2 : nat) := imp ((Coq.Arith.PeanoNat.Nat.Odd x2) /\ ((real_pow (real_of_int x0) x2) = (real_pow (real_of_int x1) x2))).
...
Definition term18 := forall y0 : nat, forall y1 : int, forall y2 : int, ((Coq.Arith.PeanoNat.Nat.Odd y0) /\ ((int_pow y1 y0) = (int_pow y2 y0))) -> y1 = y2.
...
Definition term17 (x0 : nat) := forall y0 : int, forall y1 : int, ((Coq.Arith.PeanoNat.Nat.Odd x0) /\ ((int_pow y0 x0) = (int_pow y1 x0))) -> y0 = y1.
...
Definition term10 (x0 : nat) := and (Coq.Arith.PeanoNat.Nat.Odd x0).
Definition term16 (x0 : nat) (x1 : int) := forall y0 : int, ((Coq.Arith.PeanoNat.Nat.Odd x0) /\ ((int_pow x1 x0) = (int_pow y0 x0))) -> x1 = y0.
...
Definition term11 (x0 : int) (x1 : int) (x2 : nat) := (Coq.Arith.PeanoNat.Nat.Odd x2) /\ ((real_pow (real_of_int x0) x2) = (real_pow (real_of_int x1) x2)).
...
Definition term15 (x0 : nat) (x1 : int) (x2 : int) := ((Coq.Arith.PeanoNat.Nat.Odd x0) /\ ((int_pow x1 x0) = (int_pow x2 x0))) -> x1 = x2.
Definition term12 (x0 : int) (x1 : int) (x2 : nat) := (Coq.Arith.PeanoNat.Nat.Odd x2) /\ ((int_pow x0 x2) = (int_pow x1 x2)).
