...
Definition term20 (x0 : nat) (x1 : nat) := ~ (real_le (real_of_num x0) (real_of_num x1)).
Definition term19 (x0 : nat) (x1 : nat) := real_lt (real_of_num x0) (real_of_num x1).
...
Definition term17 (x0 : real) (x1 : real) := (fun y0 : real => (real_lt y0 x0) = (~ (real_le x0 y0))) x1.
Definition term25 (x0 : nat) := forall y0 : nat, (real_lt (real_of_num x0) (real_of_num y0)) = (Peano.lt x0 y0).
Definition term10 (x0 : nat) := forall y0 : nat, (real_le (real_of_num x0) (real_of_num y0)) = (Peano.le x0 y0).
Definition term21 (x0 : nat) (x1 : nat) := @eq Prop (real_lt (real_of_num x0) (real_of_num x1)).
Definition term29 := fun y0 : nat => forall y1 : nat, (real_lt (real_of_num y0) (real_of_num y1)) = (Peano.lt y0 y1).
...
Definition term30 := forall y0 : nat, forall y1 : nat, (real_lt (real_of_num y0) (real_of_num y1)) = (Peano.lt y0 y1).
...
Definition term23 (x0 : nat) := fun y0 : nat => (real_lt (real_of_num x0) (real_of_num y0)) = (Peano.lt x0 y0).
Definition term15 (x0 : real) := (fun y0 : real => forall y1 : real, (real_lt y1 y0) = (~ (real_le y0 y1))) x0.
Definition term24 := fun y0 : nat => True.
Definition term16 (x0 : real) := forall y0 : real, (real_lt y0 x0) = (~ (real_le x0 y0)).
...
Definition term18 (x0 : real) (x1 : real) := ~ (real_le x0 x1).
Definition term14 (x0 : nat) (x1 : nat) := (fun y0 : nat => (Peano.lt y0 x0) = (~ (Peano.le x0 y0))) x1.
Definition term22 (x0 : nat) (x1 : nat) := @eq Prop (~ (Peano.le x0 x1)).
