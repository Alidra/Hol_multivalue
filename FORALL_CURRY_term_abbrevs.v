...
Definition term7 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type876 a0 a1 a2) := forall y0 : type1228 a0 a1 a2, x0 (fun y1 : a2 => fun y2 : a1 => y0 (@pair a2 a1 y1 y2)).
Definition term5 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type443 a0 a1 a2) := forall y0 : type1209 a0 a1 a2, x0 (fun y1 : a0 => fun y2 : a1 => y0 (@pair a0 a1 y1 y2)).
...
Definition term14 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := forall y0 : type1518 a0 a1 a2, x0 (@GABS ((prod a2 a1) -> a0) (fun y1 : type1228 a0 a1 a2 => forall y2 : a2, forall y3 : a1, @GEQ a0 (y1 (@pair a2 a1 y2 y3)) (y0 y2 y3))).
...
Definition term54 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := forall y0 : type1228 a0 a1 a2, x0 y0.
Definition term21 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := forall y0 : type1228 a0 a1 a2, x0 (@GABS ((prod a2 a1) -> a0) (fun y1 : type1228 a0 a1 a2 => forall y2 : a2, forall y3 : a1, @GEQ a0 (y1 (@pair a2 a1 y2 y3)) ((fun y4 : a2 => fun y5 : a1 => y0 (@pair a2 a1 y4 y5)) y2 y3))).
...
Definition term16 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := @eq Prop (forall y0 : type1518 a0 a1 a2, x0 (@GABS ((prod a2 a1) -> a0) (fun y1 : type1228 a0 a1 a2 => forall y2 : a2, forall y3 : a1, @GEQ a0 (y1 (@pair a2 a1 y2 y3)) (y0 y2 y3)))).
Definition term58 (a0 : Type') (a1 : Type') (a2 : Type') := forall y0 : type333 a0 a1 a2, (forall y1 : type1228 a0 a1 a2, y0 y1) = (forall y1 : type1518 a0 a1 a2, y0 (@GABS ((prod a2 a1) -> a0) (fun y2 : type1228 a0 a1 a2 => forall y3 : a2, forall y4 : a1, @GEQ a0 (y2 (@pair a2 a1 y3 y4)) (y1 y3 y4)))).
...
Definition term15 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := @eq Prop (forall y0 : type1518 a0 a1 a2, (fun y1 : type1518 a0 a1 a2 => x0 (@GABS ((prod a2 a1) -> a0) (fun y2 : type1228 a0 a1 a2 => forall y3 : a2, forall y4 : a1, @GEQ a0 (y2 (@pair a2 a1 y3 y4)) (y1 y3 y4)))) y0).
Definition term55 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := @eq Prop (forall y0 : type1228 a0 a1 a2, x0 y0).
...
Definition term8 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := forall y0 : type1518 a0 a1 a2, (fun y1 : type1518 a0 a1 a2 => x0 (@GABS ((prod a2 a1) -> a0) (fun y2 : type1228 a0 a1 a2 => forall y3 : a2, forall y4 : a1, @GEQ a0 (y2 (@pair a2 a1 y3 y4)) (y1 y3 y4)))) y0.
...
Definition term3 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type443 a0 a1 a2) := (fun y0 : type443 a0 a1 a2 => (forall y1 : type1412 a0 a1 a2, y0 y1) = (forall y1 : type1209 a0 a1 a2, y0 (fun y2 : a0 => fun y3 : a1 => y1 (@pair a0 a1 y2 y3)))) x0.
...
Definition term6 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type876 a0 a1 a2) := forall y0 : type1518 a0 a1 a2, x0 y0.
Definition term4 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type443 a0 a1 a2) := forall y0 : type1412 a0 a1 a2, x0 y0.
...
Definition term56 (a0 : Type') (a1 : Type') (a2 : Type') := fun y0 : type333 a0 a1 a2 => (forall y1 : type1228 a0 a1 a2, y0 y1) = (forall y1 : type1518 a0 a1 a2, y0 (@GABS ((prod a2 a1) -> a0) (fun y2 : type1228 a0 a1 a2 => forall y3 : a2, forall y4 : a1, @GEQ a0 (y2 (@pair a2 a1 y3 y4)) (y1 y3 y4)))).
Definition term33 (a0 : Type') (a1 : Type') (x0 : a1 -> a0) (x1 : a1) := (fun y0 : a1 => x0 y0) x1.
Definition term9 (a0 : Type') (a1 : Type') (a2 : Type') (x0 : type333 a0 a1 a2) := forall y0 : type1228 a0 a1 a2, (fun y1 : type1518 a0 a1 a2 => x0 (@GABS ((prod a2 a1) -> a0) (fun y2 : type1228 a0 a1 a2 => forall y3 : a2, forall y4 : a1, @GEQ a0 (y2 (@pair a2 a1 y3 y4)) (y1 y3 y4)))) (fun y1 : a2 => fun y2 : a1 => y0 (@pair a2 a1 y1 y2)).
