...
Definition term150 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => ((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0).
Definition term151 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (fun y0 : a0 -> Prop => ((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0)) x4.
Definition term195 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := and (@SUBSET a0 x0 x1).
...
Definition term162 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := exists y0 : a0 -> Prop, ~ (((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0)).
Definition term206 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := @eq Prop (~ (exists y0 : a0 -> Prop, (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ (~ (x2 (@IMAGE a0 a1 x3 y0)))))))).
...
Definition term214 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) (x2 : a0 -> a1) := (@SUBSET a0 x1 x0) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x1) /\ (@IN a0 y1 x1)) -> ((x2 y0) = (x2 y1)) = (y0 = y1)).
...
Definition term219 (a0 : Type') (a1 : Type') (x0 : type686 a1) := forall y0 : a0 -> a1, forall y1 : a0 -> Prop, forall y2 : nat, (forall y3 : a1 -> Prop, ((@FINITE a1 y3) /\ ((Peano.lt (@CARD a1 y3) y2) /\ (@SUBSET a1 y3 (@IMAGE a0 a1 y0 y1)))) -> x0 y3) = (forall y3 : a0 -> Prop, ((@FINITE a0 y3) /\ ((Peano.lt (@CARD a0 y3) y2) /\ ((@SUBSET a0 y3 y1) /\ (forall y4 : a0, forall y5 : a0, ((@IN a0 y4 y3) /\ (@IN a0 y5 y3)) -> ((y0 y4) = (y0 y5)) = (y4 = y5))))) -> x0 (@IMAGE a0 a1 y0 y3)).
Definition term18 (a0 : Type') (a1 : Type') (x0 : type686 a1) := forall y0 : a0 -> a1, forall y1 : a0 -> Prop, forall y2 : nat, (exists y3 : a1 -> Prop, (@FINITE a1 y3) /\ ((Peano.lt (@CARD a1 y3) y2) /\ ((@SUBSET a1 y3 (@IMAGE a0 a1 y0 y1)) /\ (x0 y3)))) = (exists y3 : a0 -> Prop, (@FINITE a0 y3) /\ ((Peano.lt (@CARD a0 y3) y2) /\ ((@SUBSET a0 y3 y1) /\ ((forall y4 : a0, forall y5 : a0, ((@IN a0 y4 y3) /\ (@IN a0 y5 y3)) -> ((y0 y4) = (y0 y5)) = (y4 = y5)) /\ (x0 (@IMAGE a0 a1 y0 y3)))))).
...
Definition term152 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := ((@FINITE a0 x4) /\ ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1))))) -> x2 (@IMAGE a0 a1 x3 x4).
...
Definition term198 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)) /\ ((fun y0 : a1 -> Prop => ~ (x2 y0)) (@IMAGE a0 a1 x3 x4)))).
Definition term158 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := ~ (((@FINITE a0 x4) /\ ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1))))) -> x2 (@IMAGE a0 a1 x3 x4)).
Definition term201 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (@FINITE a0 x4) /\ ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)) /\ (~ (x2 (@IMAGE a0 a1 x3 x4)))))).
Definition term200 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (@FINITE a0 x4) /\ ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)) /\ ((fun y0 : a1 -> Prop => ~ (x2 y0)) (@IMAGE a0 a1 x3 x4))))).
...
Definition term22 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) := forall y0 : nat, (exists y1 : a1 -> Prop, (@FINITE a1 y1) /\ ((Peano.lt (@CARD a1 y1) y0) /\ ((@SUBSET a1 y1 (@IMAGE a0 a1 x2 x0)) /\ (x1 y1)))) = (exists y1 : a0 -> Prop, (@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) y0) /\ ((@SUBSET a0 y1 x0) /\ ((forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x2 y2) = (x2 y3)) = (y2 = y3)) /\ (x1 (@IMAGE a0 a1 x2 y1)))))).
Definition term163 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := ~ (exists y0 : a0 -> Prop, ~ (((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0))).
Definition term149 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := ~ (exists y0 : a0 -> Prop, ~ ((fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0)).
...
Definition term220 (a0 : Type') (a1 : Type') := forall y0 : type686 a1, forall y1 : a0 -> a1, forall y2 : a0 -> Prop, forall y3 : nat, (forall y4 : a1 -> Prop, ((@FINITE a1 y4) /\ ((Peano.lt (@CARD a1 y4) y3) /\ (@SUBSET a1 y4 (@IMAGE a0 a1 y1 y2)))) -> y0 y4) = (forall y4 : a0 -> Prop, ((@FINITE a0 y4) /\ ((Peano.lt (@CARD a0 y4) y3) /\ ((@SUBSET a0 y4 y2) /\ (forall y5 : a0, forall y6 : a0, ((@IN a0 y5 y4) /\ (@IN a0 y6 y4)) -> ((y1 y5) = (y1 y6)) = (y5 = y6))))) -> y0 (@IMAGE a0 a1 y1 y4)).
...
Definition term212 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)))) /\ (~ (x2 (@IMAGE a0 a1 x3 x4))).
...
Definition term23 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) (x3 : nat) := (fun y0 : nat => (exists y1 : a1 -> Prop, (@FINITE a1 y1) /\ ((Peano.lt (@CARD a1 y1) y0) /\ ((@SUBSET a1 y1 (@IMAGE a0 a1 x2 x0)) /\ (x1 y1)))) = (exists y1 : a0 -> Prop, (@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) y0) /\ ((@SUBSET a0 y1 x0) /\ ((forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x2 y2) = (x2 y3)) = (y2 = y3)) /\ (x1 (@IMAGE a0 a1 x2 y1))))))) x3.
...
Definition term21 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) (x2 : a0 -> Prop) := (fun y0 : a0 -> Prop => forall y1 : nat, (exists y2 : a1 -> Prop, (@FINITE a1 y2) /\ ((Peano.lt (@CARD a1 y2) y1) /\ ((@SUBSET a1 y2 (@IMAGE a0 a1 x1 y0)) /\ (x0 y2)))) = (exists y2 : a0 -> Prop, (@FINITE a0 y2) /\ ((Peano.lt (@CARD a0 y2) y1) /\ ((@SUBSET a0 y2 y0) /\ ((forall y3 : a0, forall y4 : a0, ((@IN a0 y3 y2) /\ (@IN a0 y4 y2)) -> ((x1 y3) = (x1 y4)) = (y3 = y4)) /\ (x0 (@IMAGE a0 a1 x1 y2))))))) x2.
...
Definition term209 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) (x2 : a0 -> Prop) := x0 (@IMAGE a0 a1 x1 x2).
...
Definition term193 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) (x2 : a0 -> Prop) := (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x2) /\ (@IN a0 y1 x2)) -> ((x1 y0) = (x1 y1)) = (y0 = y1)) /\ ((fun y0 : a1 -> Prop => ~ (x0 y0)) (@IMAGE a0 a1 x1 x2)).
...
Definition term161 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := exists y0 : a0 -> Prop, ~ ((fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0).
...
Definition term210 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (@FINITE a0 x4) /\ (((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)))) /\ (~ (x2 (@IMAGE a0 a1 x3 x4)))).
...
Definition term155 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := @eq Prop (forall y0 : a0 -> Prop, (fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0).
...
Definition term148 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := forall y0 : a0 -> Prop, (fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0.
...
Definition term159 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => ~ ((fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0).
...
Definition term211 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0 -> a1) := (Peano.lt (@CARD a0 x2) x0) /\ ((@SUBSET a0 x2 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x2) /\ (@IN a0 y1 x2)) -> ((x3 y0) = (x3 y1)) = (y0 = y1))).
...
Definition term153 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => (fun y1 : a0 -> Prop => ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) x0) /\ ((@SUBSET a0 y1 x1) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x3 y2) = (x3 y3)) = (y2 = y3))))) -> x2 (@IMAGE a0 a1 x3 y1)) y0.
...
Definition term205 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := ~ (exists y0 : a0 -> Prop, (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ (~ (x2 (@IMAGE a0 a1 x3 y0))))))).
Definition term192 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : a0 -> a1) := and (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x0) /\ (@IN a0 y1 x0)) -> ((x1 y0) = (x1 y1)) = (y0 = y1)).
...
Definition term199 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)) /\ (~ (x2 (@IMAGE a0 a1 x3 x4))))).
...
Definition term208 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : a0 -> Prop) (x3 : a0 -> a1) := (@FINITE a0 x2) /\ ((Peano.lt (@CARD a0 x2) x0) /\ ((@SUBSET a0 x2 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x2) /\ (@IN a0 y1 x2)) -> ((x3 y0) = (x3 y1)) = (y0 = y1)))).
Definition term19 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) := (fun y0 : a0 -> a1 => forall y1 : a0 -> Prop, forall y2 : nat, (exists y3 : a1 -> Prop, (@FINITE a1 y3) /\ ((Peano.lt (@CARD a1 y3) y2) /\ ((@SUBSET a1 y3 (@IMAGE a0 a1 y0 y1)) /\ (x0 y3)))) = (exists y3 : a0 -> Prop, (@FINITE a0 y3) /\ ((Peano.lt (@CARD a0 y3) y2) /\ ((@SUBSET a0 y3 y1) /\ ((forall y4 : a0, forall y5 : a0, ((@IN a0 y4 y3) /\ (@IN a0 y5 y3)) -> ((y0 y4) = (y0 y5)) = (y4 = y5)) /\ (x0 (@IMAGE a0 a1 y0 y3))))))) x1.
...
Definition term218 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) := forall y0 : a0 -> Prop, forall y1 : nat, (forall y2 : a1 -> Prop, ((@FINITE a1 y2) /\ ((Peano.lt (@CARD a1 y2) y1) /\ (@SUBSET a1 y2 (@IMAGE a0 a1 x1 y0)))) -> x0 y2) = (forall y2 : a0 -> Prop, ((@FINITE a0 y2) /\ ((Peano.lt (@CARD a0 y2) y1) /\ ((@SUBSET a0 y2 y0) /\ (forall y3 : a0, forall y4 : a0, ((@IN a0 y3 y2) /\ (@IN a0 y4 y2)) -> ((x1 y3) = (x1 y4)) = (y3 = y4))))) -> x0 (@IMAGE a0 a1 x1 y2)).
Definition term20 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) := forall y0 : a0 -> Prop, forall y1 : nat, (exists y2 : a1 -> Prop, (@FINITE a1 y2) /\ ((Peano.lt (@CARD a1 y2) y1) /\ ((@SUBSET a1 y2 (@IMAGE a0 a1 x1 y0)) /\ (x0 y2)))) = (exists y2 : a0 -> Prop, (@FINITE a0 y2) /\ ((Peano.lt (@CARD a0 y2) y1) /\ ((@SUBSET a0 y2 y0) /\ ((forall y3 : a0, forall y4 : a0, ((@IN a0 y3 y2) /\ (@IN a0 y4 y2)) -> ((x1 y3) = (x1 y4)) = (y3 = y4)) /\ (x0 (@IMAGE a0 a1 x1 y2)))))).
...
Definition term156 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := @eq Prop (forall y0 : a0 -> Prop, ((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0)).
Definition term196 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) (x3 : a0 -> Prop) := (@SUBSET a0 x3 x0) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x3) /\ (@IN a0 y1 x3)) -> ((x2 y0) = (x2 y1)) = (y0 = y1)) /\ ((fun y0 : a1 -> Prop => ~ (x1 y0)) (@IMAGE a0 a1 x2 x3))).
Definition term181 (a0 : Type') (a1 : Type') (x0 : a1 -> Prop) (x1 : a0 -> a1) (x2 : a0 -> Prop) := and (@SUBSET a1 x0 (@IMAGE a0 a1 x1 x2)).
Definition term194 (a0 : Type') (a1 : Type') (x0 : type686 a1) (x1 : a0 -> a1) (x2 : a0 -> Prop) := (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x2) /\ (@IN a0 y1 x2)) -> ((x1 y0) = (x1 y1)) = (y0 = y1)) /\ (~ (x0 (@IMAGE a0 a1 x1 x2))).
...
Definition term197 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) (x3 : a0 -> Prop) := (@SUBSET a0 x3 x0) /\ ((forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x3) /\ (@IN a0 y1 x3)) -> ((x2 y0) = (x2 y1)) = (y0 = y1)) /\ (~ (x1 (@IMAGE a0 a1 x2 x3)))).
...
Definition term216 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : a0 -> a1) := forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x0) /\ (@IN a0 y1 x0)) -> ((x1 y0) = (x1 y1)) = (y0 = y1).
...
Definition term157 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := ~ ((fun y0 : a0 -> Prop => ((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0)) x4).
Definition term203 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ (~ (x2 (@IMAGE a0 a1 x3 y0)))))).
Definition term202 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ ((fun y1 : a1 -> Prop => ~ (x2 y1)) (@IMAGE a0 a1 x3 y0))))).
...
Definition term160 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := fun y0 : a0 -> Prop => ~ (((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0)).
...
Definition term204 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := exists y0 : a0 -> Prop, (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ (~ (x2 (@IMAGE a0 a1 x3 y0)))))).
Definition term178 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := exists y0 : a0 -> Prop, (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ ((fun y1 : a1 -> Prop => ~ (x2 y1)) (@IMAGE a0 a1 x3 y0))))).
Definition term25 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := exists y0 : a0 -> Prop, (@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ ((forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2)) /\ (x2 (@IMAGE a0 a1 x3 y0))))).
Definition term89 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (exists y0 : a0, x0 y0) /\ x1.
Definition term207 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := ((@FINITE a0 x4) /\ ((Peano.lt (@CARD a0 x4) x0) /\ ((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1))))) /\ (~ (x2 (@IMAGE a0 a1 x3 x4))).
Definition term213 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) (x4 : a0 -> Prop) := (Peano.lt (@CARD a0 x4) x0) /\ (((@SUBSET a0 x4 x1) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x4) /\ (@IN a0 y1 x4)) -> ((x3 y0) = (x3 y1)) = (y0 = y1))) /\ (~ (x2 (@IMAGE a0 a1 x3 x4)))).
...
Definition term217 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) := forall y0 : nat, (forall y1 : a1 -> Prop, ((@FINITE a1 y1) /\ ((Peano.lt (@CARD a1 y1) y0) /\ (@SUBSET a1 y1 (@IMAGE a0 a1 x2 x0)))) -> x1 y1) = (forall y1 : a0 -> Prop, ((@FINITE a0 y1) /\ ((Peano.lt (@CARD a0 y1) y0) /\ ((@SUBSET a0 y1 x0) /\ (forall y2 : a0, forall y3 : a0, ((@IN a0 y2 y1) /\ (@IN a0 y3 y1)) -> ((x2 y2) = (x2 y3)) = (y2 = y3))))) -> x1 (@IMAGE a0 a1 x2 y1)).
Definition term215 (a0 : Type') (a1 : Type') (x0 : a0 -> Prop) (x1 : type686 a1) (x2 : a0 -> a1) (x3 : a0 -> Prop) := ((@SUBSET a0 x3 x0) /\ (forall y0 : a0, forall y1 : a0, ((@IN a0 y0 x3) /\ (@IN a0 y1 x3)) -> ((x2 y0) = (x2 y1)) = (y0 = y1))) /\ (~ (x1 (@IMAGE a0 a1 x2 x3))).
...
Definition term154 (a0 : Type') (a1 : Type') (x0 : nat) (x1 : a0 -> Prop) (x2 : type686 a1) (x3 : a0 -> a1) := forall y0 : a0 -> Prop, ((@FINITE a0 y0) /\ ((Peano.lt (@CARD a0 y0) x0) /\ ((@SUBSET a0 y0 x1) /\ (forall y1 : a0, forall y2 : a0, ((@IN a0 y1 y0) /\ (@IN a0 y2 y0)) -> ((x3 y1) = (x3 y2)) = (y1 = y2))))) -> x2 (@IMAGE a0 a1 x3 y0).
...
Definition term17 (a0 : Type') (a1 : Type') (x0 : type686 a1) := (fun y0 : type686 a1 => forall y1 : a0 -> a1, forall y2 : a0 -> Prop, forall y3 : nat, (exists y4 : a1 -> Prop, (@FINITE a1 y4) /\ ((Peano.lt (@CARD a1 y4) y3) /\ ((@SUBSET a1 y4 (@IMAGE a0 a1 y1 y2)) /\ (y0 y4)))) = (exists y4 : a0 -> Prop, (@FINITE a0 y4) /\ ((Peano.lt (@CARD a0 y4) y3) /\ ((@SUBSET a0 y4 y2) /\ ((forall y5 : a0, forall y6 : a0, ((@IN a0 y5 y4) /\ (@IN a0 y6 y4)) -> ((y1 y5) = (y1 y6)) = (y5 = y6)) /\ (y0 (@IMAGE a0 a1 y1 y4))))))) x0.
