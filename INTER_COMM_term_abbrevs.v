...
Definition term15 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := @eq Prop (@IN a0 x0 (@INTER a0 x1 x2)).
...
Definition term9 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, forall y2 : a0, (@IN a0 y2 (@INTER a0 y0 y1)) = (@IN a0 y2 (@INTER a0 y1 y0)).
...
Definition term10 (a0 : Type') (x0 : a0) (x1 : a0 -> Prop) (x2 : a0 -> Prop) := @IN a0 x0 (@INTER a0 x1 x2).
...
Definition term4 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0 -> Prop, (@INTER a0 x0 y0) = (@INTER a0 y0 x0).
...
Definition term3 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 -> Prop => forall y1 : a0, (@IN a0 y1 (@INTER a0 x0 y0)) = (@IN a0 y1 (@INTER a0 y0 x0)).
Definition term13 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) := and (x0 x1).
...
Definition term8 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : a0 -> Prop, (@INTER a0 y0 y1) = (@INTER a0 y1 y0).
...
Definition term2 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 -> Prop => (@INTER a0 x0 y0) = (@INTER a0 y0 x0).
...
Definition term7 (a0 : Type') := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, forall y2 : a0, (@IN a0 y2 (@INTER a0 y0 y1)) = (@IN a0 y2 (@INTER a0 y1 y0)).
Definition term1 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := forall y0 : a0, (@IN a0 y0 (@INTER a0 x1 x0)) = (@IN a0 y0 (@INTER a0 x0 x1)).
...
Definition term17 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0 -> Prop) := fun y0 : a0 => (@IN a0 y0 (@INTER a0 x1 x0)) = (@IN a0 y0 (@INTER a0 x0 x1)).
...
Definition term5 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0 -> Prop, forall y1 : a0, (@IN a0 y1 (@INTER a0 x0 y0)) = (@IN a0 y1 (@INTER a0 y0 x0)).
Definition term6 (a0 : Type') := fun y0 : a0 -> Prop => forall y1 : a0 -> Prop, (@INTER a0 y0 y1) = (@INTER a0 y1 y0).
