...
Definition term3 := forall y0 : nat, (Nat.add 0 (BIT1 y0)) = (BIT1 y0).
...
Definition term4 (x0 : nat) := (fun y0 : nat => (Nat.add 0 (BIT1 y0)) = (BIT1 y0)) x0.
Definition term5 (x0 : nat) := Nat.add 0 (BIT1 x0).
Definition term6 := Nat.add 0 (BIT1 0).
Definition term8 := S (BIT1 0).
Definition term7 := S (Nat.add 0 (BIT1 0)).
