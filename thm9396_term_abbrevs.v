...
Definition term22 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 => x0 y0.
Definition term25 (a0 : Type') (x0 : a0 -> Prop) := ((ex x0) -> (x0 (@ε a0 x0)) = True) -> ((ex x0) -> x0 (@ε a0 x0)) = ((ex x0) -> True).
Definition term27 (a0 : Type') (x0 : a0 -> Prop) := (ex x0) -> True.
...
Definition term18 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) (x2 : Prop) := (fun y0 : Prop => ((ex x0) = x1) -> (x1 -> (x0 (@ε a0 x0)) = y0) -> ((ex x0) -> x0 (@ε a0 x0)) = (x1 -> y0)) x2.
...
Definition term21 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := ((ex x0) -> (x0 (@ε a0 x0)) = x1) -> ((ex x0) -> x0 (@ε a0 x0)) = ((ex x0) -> x1).
Definition term6 (a0 : Type') (x0 : a0 -> Prop) := x0 (@ε a0 x0).
Definition term17 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := forall y0 : Prop, ((ex x0) = x1) -> (x1 -> (x0 (@ε a0 x0)) = y0) -> ((ex x0) -> x0 (@ε a0 x0)) = (x1 -> y0).
Definition term13 (x0 : Prop) (x1 : Prop) (x2 : Prop) := forall y0 : Prop, (x0 = x2) -> (x2 -> x1 = y0) -> (x0 -> x1) = (x2 -> y0).
Definition term26 (a0 : Type') (x0 : a0 -> Prop) := (ex x0) -> x0 (@ε a0 x0).
Definition term11 (a0 : Type') (x0 : a0 -> Prop) := (exists y0 : a0, x0 y0) -> (x0 (@ε a0 x0)) = True.
Definition term15 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : Prop, forall y1 : Prop, ((ex x0) = y0) -> (y0 -> (x0 (@ε a0 x0)) = y1) -> ((ex x0) -> x0 (@ε a0 x0)) = (y0 -> y1).
Definition term14 (x0 : Prop) (x1 : Prop) := forall y0 : Prop, forall y1 : Prop, (x0 = y0) -> (y0 -> x1 = y1) -> (x0 -> x1) = (y0 -> y1).
Definition term24 (a0 : Type') (x0 : a0 -> Prop) := (ex x0) -> (x0 (@ε a0 x0)) = True.
...
Definition term20 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := ((ex x0) = (ex x0)) -> ((ex x0) -> (x0 (@ε a0 x0)) = x1) -> ((ex x0) -> x0 (@ε a0 x0)) = ((ex x0) -> x1).
Definition term16 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (fun y0 : Prop => forall y1 : Prop, ((ex x0) = y0) -> (y0 -> (x0 (@ε a0 x0)) = y1) -> ((ex x0) -> x0 (@ε a0 x0)) = (y0 -> y1)) x1.
Definition term19 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) (x2 : Prop) := ((ex x0) = x1) -> (x1 -> (x0 (@ε a0 x0)) = x2) -> ((ex x0) -> x0 (@ε a0 x0)) = (x1 -> x2).
