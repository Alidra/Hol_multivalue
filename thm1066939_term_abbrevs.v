...
Definition term1 (a0 : Type') (a1 : Type') (x0 : type1431 a0 a1) (x1 : type1479 a0 a1) (x2 : type1333 a0 a1) := forall y0 : type1333 a0 a1, ((forall y1 : a0, y0 (x0 y1)) /\ (forall y1 : a1, y0 (x1 y1))) -> forall y1 : type1677 a0 a1, (x2 y1) -> y0 y1.
