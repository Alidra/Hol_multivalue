...
Definition term1 (a0 : Type') (x0 : recspace a0) (x1 : type1432 a0) (x2 : type1338 a0) := forall y0 : type1338 a0, ((y0 x0) /\ (forall y1 : a0, y0 (x1 y1))) -> forall y1 : recspace a0, (x2 y1) -> y0 y1.
