...
Definition term10 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : Prop, (forall y2 : a0, (y0 y2) -> y1) = ((exists y2 : a0, y0 y2) -> y1).
Definition term3 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) (x2 : Prop) := (x0 x1) -> x2.
Definition term9 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : Prop, (forall y1 : a0, (x0 y1) -> y0) = ((exists y1 : a0, x0 y1) -> y0).
