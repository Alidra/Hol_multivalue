...
Definition term33 (x0 : nat) (x1 : nat) := exists y0 : nat, (x0 = (Nat.add (Nat.mul (NUMERAL 0) x1) y0)) /\ (Peano.lt y0 x1).
...
Definition term21 (x0 : nat) (x1 : nat) := (exists y0 : nat, (x0 = (Nat.add (Nat.mul (NUMERAL 0) x1) y0)) /\ (Peano.lt y0 x1)) -> (Nat.div x0 x1) = (NUMERAL 0).
...
Definition term36 (x0 : nat) := forall y0 : nat, (Peano.lt x0 y0) -> (Nat.div x0 y0) = (NUMERAL 0).
Definition term35 (x0 : nat) (x1 : nat) := (Peano.lt x0 x1) -> (Nat.div x0 x1) = (NUMERAL 0).
Definition term28 (x0 : nat) := Nat.add (Nat.mul (NUMERAL 0) x0).
Definition term34 (x0 : nat) (x1 : nat) := fun y0 : nat => (x0 = (Nat.add (Nat.mul (NUMERAL 0) x1) y0)) /\ (Peano.lt y0 x1).
...
Definition term37 := forall y0 : nat, forall y1 : nat, (Peano.lt y0 y1) -> (Nat.div y0 y1) = (NUMERAL 0).
