...
Definition term7 := forall y0 : real, (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = (real_abs y0).
Definition term3 (x0 : real) := @eq real (real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0)))).
Definition term0 (x0 : real) := (fun y0 : real => ((real_sgn (sqrt y0)) = (real_sgn y0)) /\ ((real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = (real_abs y0))) x0.
Definition term5 := fun y0 : real => (real_pow (sqrt y0) (NUMERAL (BIT0 (BIT1 0)))) = (real_abs y0).
Definition term4 (x0 : real) := @eq real (real_abs x0).
Definition term2 (x0 : real) := real_pow (sqrt x0) (NUMERAL (BIT0 (BIT1 0))).
