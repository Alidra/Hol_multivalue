...
Definition term14 (x0 : real) (x1 : real) := @eq Prop (~ (real_le (real_of_num (NUMERAL 0)) (real_add x0 x1))).
...
Definition term13 (x0 : real) (x1 : real) := @eq Prop (real_lt x0 (real_neg x1)).
Definition term18 := fun y0 : real => True.
Definition term20 := forall y0 : real, True.
Definition term22 (x0 : Prop) := forall y0 : real, x0.
Definition term12 (x0 : real) (x1 : real) := ~ (real_le (real_of_num (NUMERAL 0)) (real_add x0 x1)).
Definition term24 := forall y0 : real, forall y1 : real, (real_lt y0 (real_neg y1)) = (real_lt (real_add y0 y1) (real_of_num (NUMERAL 0))).
Definition term11 := real_le (real_of_num (NUMERAL 0)).
Definition term17 (x0 : real) := fun y0 : real => (real_lt x0 (real_neg y0)) = (real_lt (real_add x0 y0) (real_of_num (NUMERAL 0))).
Definition term23 := fun y0 : real => forall y1 : real, (real_lt y0 (real_neg y1)) = (real_lt (real_add y0 y1) (real_of_num (NUMERAL 0))).
...
Definition term9 (x0 : real) (x1 : real) := real_lt x0 (real_neg x1).
Definition term10 (x0 : real) (x1 : real) := ~ (real_le (real_neg x0) x1).
Definition term8 (x0 : real) (x1 : real) := ~ (real_le x0 x1).
Definition term15 (x0 : real) (x1 : real) := real_lt (real_add x0 x1) (real_of_num (NUMERAL 0)).
