...
Definition term4 := (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False.
...
Definition term120 (x0 : nat) := (~ ((Nat.div x0 (NUMERAL 0)) = (NUMERAL 0))) -> (Nat.div x0 (NUMERAL 0)) = (NUMERAL 0).
...
Definition term111 (x0 : nat) (x1 : nat) := @eq Prop (((Nat.div x0 x1) = (NUMERAL 0)) \/ (~ (x1 = (NUMERAL 0)))).
...
Definition term3 := ~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0)).
...
Definition term119 (x0 : nat) := ((NUMERAL 0) = (NUMERAL 0)) -> (Nat.div x0 (NUMERAL 0)) = (NUMERAL 0).
...
Definition term105 (x0 : nat) (x1 : nat) := (~ (x1 = (NUMERAL 0))) \/ ((Nat.div x0 x1) = (NUMERAL 0)).
...
Definition term43 (x0 : nat) := ~ ((fun y0 : nat => (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0)) x0).
Definition term117 (x0 : nat) := imp (x0 = (NUMERAL 0)).
Definition term42 (x0 : nat) := (fun y0 : nat => (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0)) x0.
...
Definition term6 := (((~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False.
...
Definition term121 (x0 : nat) := ((Nat.div x0 (NUMERAL 0)) = (NUMERAL 0)) -> False.
...
Definition term2 := (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> False.
...
Definition term37 := fun y0 : nat => (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0).
Definition term46 := fun y0 : nat => ~ ((Nat.div y0 (NUMERAL 0)) = (NUMERAL 0)).
...
Definition term113 (x0 : nat) (x1 : nat) := (~ (~ (x1 = (NUMERAL 0)))) -> (Nat.div x0 x1) = (NUMERAL 0).
...
Definition term118 (x0 : nat) (x1 : nat) := (x1 = (NUMERAL 0)) -> (Nat.div x0 x1) = (NUMERAL 0).
...
Definition term1 := forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0).
Definition term110 (x0 : nat) (x1 : nat) := @eq Prop ((~ (x1 = (NUMERAL 0))) \/ ((Nat.div x0 x1) = (NUMERAL 0))).
Definition term41 := exists y0 : nat, ~ ((fun y1 : nat => (Nat.div y1 (NUMERAL 0)) = (NUMERAL 0)) y0).
Definition term38 := (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> ~ (forall y0 : nat, forall y1 : nat, ((~ (y1 = (NUMERAL 0))) \/ (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0))) /\ ((y1 = (NUMERAL 0)) \/ ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1)))).
Definition term12 := (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> ~ (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))).
Definition term44 (x0 : nat) := ~ ((Nat.div x0 (NUMERAL 0)) = (NUMERAL 0)).
...
Definition term47 := exists y0 : nat, ~ ((Nat.div y0 (NUMERAL 0)) = (NUMERAL 0)).
...
Definition term45 := fun y0 : nat => ~ ((fun y1 : nat => (Nat.div y1 (NUMERAL 0)) = (NUMERAL 0)) y0).
...
Definition term5 := ((~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False.
...
Definition term7 := (((~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> ((~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False) -> (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))) -> (forall y0 : nat, forall y1 : nat, @COND Prop (y1 = (NUMERAL 0)) (((Nat.div y0 y1) = (NUMERAL 0)) /\ ((Nat.modulo y0 y1) = y0)) ((y0 = (Nat.add (Nat.mul (Nat.div y0 y1) y1) (Nat.modulo y0 y1))) /\ (Peano.lt (Nat.modulo y0 y1) y1))) -> False.
Definition term36 (x0 : nat) := Nat.div x0 (NUMERAL 0).
Definition term109 (x0 : nat) (x1 : nat) := ((Nat.div x0 x1) = (NUMERAL 0)) \/ (~ (x1 = (NUMERAL 0))).
...
Definition term11 := imp (~ (forall y0 : nat, (Nat.div y0 (NUMERAL 0)) = (NUMERAL 0))).
