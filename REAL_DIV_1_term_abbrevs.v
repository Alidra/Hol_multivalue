...
Definition term12 := fun y0 : real => True.
Definition term14 := forall y0 : real, True.
...
Definition term11 := fun y0 : real => (real_div y0 (real_of_num (NUMERAL (BIT1 0)))) = y0.
...
Definition term7 (x0 : real) := real_mul x0 (real_inv (real_of_num (NUMERAL (BIT1 0)))).
Definition term10 (x0 : real) := @eq real (real_div x0 (real_of_num (NUMERAL (BIT1 0)))).
Definition term13 := forall y0 : real, (real_div y0 (real_of_num (NUMERAL (BIT1 0)))) = y0.
Definition term6 (x0 : real) := real_div x0 (real_of_num (NUMERAL (BIT1 0))).
Definition term8 := real_of_num (NUMERAL (BIT1 0)).
Definition term9 := real_inv (real_of_num (NUMERAL (BIT1 0))).
