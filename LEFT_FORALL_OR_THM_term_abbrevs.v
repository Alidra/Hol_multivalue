...
Definition term66 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (~ (forall y0 : a0, x0 y0)) /\ (~ x1).
Definition term14 (x0 : Prop) := fun y0 : Prop => (y0 = x0) = ((~ y0) = (~ x0)).
Definition term23 (x0 : Prop) := @eq Prop (False = x0).
Definition term28 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := ~ (forall y0 : a0, (x0 y0) \/ x1).
Definition term22 (x0 : Prop) := ~ (~ x0).
Definition term20 (x0 : Prop) := @eq Prop (True = x0).
Definition term61 (a0 : Type') (x0 : a0 -> Prop) := exists y0 : a0, (fun y1 : a0 => ~ (x0 y1)) y0.
Definition term47 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => (~ (x0 y0)) /\ (~ x1).
Definition term53 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) := ~ (x0 x1).
Definition term30 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := ~ (forall y0 : a0, (fun y1 : a0 => (x0 y1) \/ x1) y0).
Definition term18 (x0 : Prop) (x1 : Prop) := @eq Prop ((x0 = x1) = ((~ x0) = (~ x1))).
Definition term67 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0, x0 y0.
...
Definition term42 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => ~ ((x0 y0) \/ x1).
...
Definition term59 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := @eq Prop (exists y0 : a0, (~ (x0 y0)) /\ (~ x1)).
Definition term58 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := @eq Prop (exists y0 : a0, ((fun y1 : a0 => ~ (x0 y1)) y0) /\ (~ x1)).
Definition term43 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := exists y0 : a0, ~ ((x0 y0) \/ x1).
...
Definition term35 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => (fun y1 : a0 => (x0 y1) \/ x1) y0.
Definition term54 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) := and ((fun y0 : a0 => ~ (x0 y0)) x1).
Definition term29 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := ~ ((forall y0 : a0, x0 y0) \/ x1).
Definition term36 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := forall y0 : a0, (fun y1 : a0 => (x0 y1) \/ x1) y0.
Definition term65 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := @eq Prop ((exists y0 : a0, ~ (x0 y0)) /\ (~ x1)).
Definition term64 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (exists y0 : a0, ~ (x0 y0)) /\ (~ x1).
Definition term50 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (exists y0 : a0, (fun y1 : a0 => ~ (x0 y1)) y0) /\ (~ x1).
Definition term60 (a0 : Type') (x0 : a0 -> Prop) := fun y0 : a0 => (fun y1 : a0 => ~ (x0 y1)) y0.
Definition term56 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) (x2 : Prop) := ((fun y0 : a0 => ~ (x0 y0)) x1) /\ (~ x2).
...
Definition term26 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := forall y0 : a0, (x0 y0) \/ x1.
Definition term21 := @eq Prop (~ True).
Definition term13 (x0 : Prop) := (x0 = True) \/ (x0 = False).
Definition term70 (a0 : Type') := forall y0 : a0 -> Prop, forall y1 : Prop, (forall y2 : a0, (y0 y2) \/ y1) = ((forall y2 : a0, y0 y2) \/ y1).
Definition term41 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => ~ ((fun y1 : a0 => (x0 y1) \/ x1) y0).
Definition term31 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := exists y0 : a0, ~ ((fun y1 : a0 => (x0 y1) \/ x1) y0).
Definition term38 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := @eq Prop (~ (forall y0 : a0, (x0 y0) \/ x1)).
Definition term37 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := @eq Prop (~ (forall y0 : a0, (fun y1 : a0 => (x0 y1) \/ x1) y0)).
Definition term69 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : Prop, (forall y1 : a0, (x0 y1) \/ y0) = ((forall y1 : a0, x0 y1) \/ y0).
Definition term1 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : Prop, (exists y1 : a0, (x0 y1) /\ y0) = ((exists y1 : a0, x0 y1) /\ y0).
Definition term33 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) (x2 : a0) := (fun y0 : a0 => (x0 y0) \/ x1) x2.
Definition term48 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := exists y0 : a0, (~ (x0 y0)) /\ (~ x1).
Definition term49 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := exists y0 : a0, ((fun y1 : a0 => ~ (x0 y1)) y0) /\ (~ x1).
Definition term68 (a0 : Type') (x0 : a0 -> Prop) := and (~ (forall y0 : a0, x0 y0)).
Definition term57 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => ((fun y1 : a0 => ~ (x0 y1)) y0) /\ (~ x1).
Definition term4 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := (exists y0 : a0, x0 y0) /\ x1.
...
Definition term62 (a0 : Type') (x0 : a0 -> Prop) := and (exists y0 : a0, (fun y1 : a0 => ~ (x0 y1)) y0).
Definition term34 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) (x2 : Prop) := (x0 x1) \/ x2.
Definition term55 (a0 : Type') (x0 : a0 -> Prop) (x1 : a0) := and (~ (x0 x1)).
Definition term32 (a0 : Type') (x0 : a0 -> Prop) (x1 : Prop) := fun y0 : a0 => (x0 y0) \/ x1.
