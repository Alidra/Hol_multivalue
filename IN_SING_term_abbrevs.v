...
Definition term13 (a0 : Type') (x0 : a0) (x1 : a0) := (x0 = x1) \/ False.
Definition term19 (a0 : Type') := forall y0 : a0, True.
Definition term21 (a0 : Type') := fun y0 : a0 => forall y1 : a0, (@IN a0 y0 (@INSERT a0 y1 (@EMPTY a0))) = (y0 = y1).
Definition term3 (a0 : Type') (x0 : a0) := (fun y0 : a0 => forall y1 : a0, forall y2 : a0 -> Prop, (@IN a0 y0 (@INSERT a0 y1 y2)) = ((y0 = y1) \/ (@IN a0 y0 y2))) x0.
Definition term16 (a0 : Type') (x0 : a0) := fun y0 : a0 => (@IN a0 x0 (@INSERT a0 y0 (@EMPTY a0))) = (x0 = y0).
Definition term17 (a0 : Type') := fun y0 : a0 => True.
Definition term14 (a0 : Type') (x0 : a0) (x1 : a0) := @eq Prop (@IN a0 x0 (@INSERT a0 x1 (@EMPTY a0))).
Definition term7 (a0 : Type') (x0 : a0) (x1 : a0) (x2 : a0 -> Prop) := (fun y0 : a0 -> Prop => (@IN a0 x1 (@INSERT a0 x0 y0)) = ((x1 = x0) \/ (@IN a0 x1 y0))) x2.
Definition term12 (a0 : Type') (x0 : a0) (x1 : a0) := or (x0 = x1).
Definition term15 (a0 : Type') (x0 : a0) (x1 : a0) := @eq Prop (x0 = x1).
Definition term11 (a0 : Type') (x0 : a0) (x1 : a0) := (x1 = x0) \/ (@IN a0 x1 (@EMPTY a0)).
Definition term10 (a0 : Type') (x0 : a0) (x1 : a0) := @IN a0 x0 (@INSERT a0 x1 (@EMPTY a0)).
Definition term22 (a0 : Type') := forall y0 : a0, forall y1 : a0, (@IN a0 y0 (@INSERT a0 y1 (@EMPTY a0))) = (y0 = y1).
