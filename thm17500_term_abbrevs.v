...
Definition term20 (x0 : Prop) := (~ False) /\ (~ x0).
...
Definition term12 (x0 : Prop) := or (True /\ x0).
Definition term14 (x0 : Prop) := (~ True) /\ (~ x0).
