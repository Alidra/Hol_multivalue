...
Definition term3 := @ε real (fun y0 : real => forall y1 : real, ((real_add y0 y1) = y1) /\ ((real_add y1 y0) = y1)).
...
Definition term4 := @eq real (@neutral real real_add).
Definition term5 := @eq real (@ε real (fun y0 : real => forall y1 : real, ((real_add y0 y1) = y1) /\ ((real_add y1 y0) = y1))).
