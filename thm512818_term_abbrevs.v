...
Definition term28 := @eq nat (NUMERAL (NUMERAL 0)).
Definition term29 := and ((NUMERAL (NUMERAL 0)) = (NUMERAL 0)).
...
Definition term30 := @eq nat (BIT0 0).
Definition term27 := NUMERAL (NUMERAL 0).
Definition term25 (x0 : nat) := (fun y0 : nat => (BIT0 y0) = (Nat.add y0 y0)) x0.
Definition term11 (x0 : nat) := @eq nat (Nat.add x0 (NUMERAL 0)).
Definition term26 (x0 : nat) := (fun y0 : nat => (NUMERAL y0) = y0) x0.
...
Definition term24 (x0 : nat) := (fun y0 : nat => (Nat.add 0 y0) = y0) x0.
...
Definition term31 := ((NUMERAL (NUMERAL 0)) = (NUMERAL 0)) /\ ((BIT0 0) = 0).
