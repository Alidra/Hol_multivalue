...
Definition term25 := forall y0 : real, ((real_lt (real_of_num (NUMERAL 0)) y0) /\ (real_lt y0 (real_of_num (NUMERAL (BIT1 0))))) -> real_lt (real_of_num (NUMERAL (BIT1 0))) (real_inv y0).
...
Definition term16 (x0 : real) := real_lt x0 (real_of_num (NUMERAL (BIT1 0))).
Definition term18 := real_lt (real_of_num (NUMERAL (BIT1 0))).
Definition term24 (x0 : real) := ((real_lt (real_of_num (NUMERAL 0)) x0) /\ (real_lt x0 (real_of_num (NUMERAL (BIT1 0))))) -> real_lt (real_of_num (NUMERAL (BIT1 0))) (real_inv x0).
...
Definition term22 (x0 : real) := ((real_lt (real_of_num (NUMERAL 0)) x0) /\ (real_lt x0 (real_of_num (NUMERAL (BIT1 0))))) -> real_lt (real_inv (real_of_num (NUMERAL (BIT1 0)))) (real_inv x0).
Definition term6 (x0 : real) (x1 : real) := real_lt (real_inv x0) (real_inv x1).
Definition term21 (x0 : real) := real_lt (real_inv (real_of_num (NUMERAL (BIT1 0)))) (real_inv x0).
Definition term17 (x0 : real) := real_lt (real_of_num (NUMERAL 0)) x0.
Definition term20 (x0 : real) := real_lt (real_of_num (NUMERAL (BIT1 0))) (real_inv x0).
Definition term14 := real_of_num (NUMERAL (BIT1 0)).
Definition term13 := real_inv (real_of_num (NUMERAL (BIT1 0))).
Definition term15 (x0 : real) := (real_lt (real_of_num (NUMERAL 0)) x0) /\ (real_lt x0 (real_of_num (NUMERAL (BIT1 0)))).
Definition term19 := real_lt (real_inv (real_of_num (NUMERAL (BIT1 0)))).
