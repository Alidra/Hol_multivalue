...
Definition term11 (a0 : Type') (x0 : a0) := ~ (@IN a0 x0 (@EMPTY a0)).
Definition term0 (a0 : Type') (x0 : a0 -> Prop) := (fun y0 : a0 -> Prop => forall y1 : a0, (@IN a0 y1 y0) = (y0 y1)) x0.
Definition term10 (a0 : Type') (x0 : a0) := @eq Prop ((fun y0 : a0 => False) x0).
Definition term8 (a0 : Type') := fun y0 : a0 => (fun y1 : a0 => False) y0.
Definition term16 (a0 : Type') (x0 : Prop) := forall y0 : a0, x0.
Definition term15 (a0 : Type') := forall y0 : a0, True.
Definition term14 (a0 : Type') := forall y0 : a0, ~ (@IN a0 y0 (@EMPTY a0)).
Definition term7 (a0 : Type') (x0 : a0) := (fun y0 : a0 => (fun y1 : a0 => False) y0) x0.
...
Definition term4 (a0 : Type') (x0 : a0) := (fun y0 : a0 => False) x0.
Definition term1 (a0 : Type') (x0 : a0 -> Prop) := forall y0 : a0, (@IN a0 y0 x0) = (x0 y0).
Definition term12 (a0 : Type') := fun y0 : a0 => ~ (@IN a0 y0 (@EMPTY a0)).
Definition term3 (a0 : Type') := fun y0 : a0 => False.
Definition term9 (a0 : Type') (x0 : a0) := @eq Prop ((fun y0 : a0 => (fun y1 : a0 => False) y0) x0).
