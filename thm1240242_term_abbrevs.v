...
Definition term1 (x0 : type1335) (x1 : type1539) := forall y0 : Prop, forall y1 : Prop, forall y2 : Prop, forall y3 : Prop, forall y4 : Prop, forall y5 : Prop, forall y6 : Prop, forall y7 : Prop, x0 (x1 y0 y1 y2 y3 y4 y5 y6 y7).
