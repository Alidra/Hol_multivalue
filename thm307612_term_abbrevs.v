...
Definition term2 (a0 : Type') (x0 : type1402 a0) := @eq Prop (@WF a0 x0).
Definition term3 (a0 : Type') (x0 : type1402 a0) := @eq Prop (forall y0 : a0 -> Prop, (exists y1 : a0, y0 y1) -> exists y1 : a0, (y0 y1) /\ (forall y2 : a0, (x0 y2 y1) -> ~ (y0 y2))).
